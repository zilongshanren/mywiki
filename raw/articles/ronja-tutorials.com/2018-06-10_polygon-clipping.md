...
url: https://www.ronja-tutorials.com/post/014-polygon-clipping/
...
Because this tutorial explains a simple technique that doesn’t do that much with fancy graphics I will explain it in a unlit shader, but it will work the same way in surface shaders. The base for this tutorial will be my simple shader with properties, so you should know how to do that before starting [this tutorial](https://www.ronja-tutorials.com/basics/)

![Result](../../assets/274965e941536404.gif)


## Draw Line [🔗︎](#draw-line)
...
![The Vectors we can combine for stuff](../../assets/42c84ecb833fd02b.png)
...
![a diagonal line which is very smooth](../../assets/c3c71de7e3bbcc4c.png)
...
![a diagonal line](../../assets/8e8eb857bd517b9b.png)
...
## Draw a Polygon of multiple lines [🔗︎](#draw-a-polygon-of-multiple-lines)
...
![a black triangle on a white plane](../../assets/19efaa7b1d08937d.png)
...
### Filling the Corner Array [🔗︎](#filling-the-corner-array)
...
![unity inspector where we can see the corner array](../../assets/54f1750997a50eb1.png)
...
![a black hexagon on a white plane](../../assets/e1414b2648a54310.png)
...
## Clip and Color the Polygon [🔗︎](#clip-and-color-the-polygon)
...
![super - hexagon](../../assets/2a73bd136cc199cf.png)


![the shape not being displayed properly when trying to make a concave shape](../../assets/ec381f262646f0e0.gif)
