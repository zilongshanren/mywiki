...
url: https://www.ronja-tutorials.com/post/016-postprocessing-basics/
...
Postprocessing still uses the same shader language and structure as shaders that render surfaces, so I’d recommend you to know how to render surfaces first. If you have read/understand my [tutorial about rendering rextures](https://www.ronja-tutorials.com/post/004-basic/) you should be fine.

![Result](../../assets/6ac2ea5bb707e096.jpg)


## Postprocessing Shader [🔗︎](#postprocessing-shader)
...
Because most of the structure is the same as other shaders, we’re going to use the textured shader as a base for this one, you can find it [here](https://www.ronja-tutorials.com/post/004-basic/)
...
## Postprocessing C# Script [🔗︎](#postprocessing-c-script)
...
![The inspector of the material without properties](../../assets/1aadb3c44fc448b1.png)
...
![the camera gameobject with the postprocessing component](../../assets/11f5882406b5024a.png)


## Negative Colors Effect [🔗︎](#negative-colors-effect)
