...
url: https://www.ronja-tutorials.com/post/011-chessboard/
...
This tutorial will build on the [simple shader with only properties](https://www.ronja-tutorials.com/basics/), but as always, you can also use the technique to generate colors in more complex shaders.

![Result of the tutorial](../../assets/e4cb1e1448661faa.png)
...
![stripes on a material](../../assets/6be7cb5f37c8bc85.png)


## Checkerboard in 2d and 3d [🔗︎](#checkerboard-in-2d-and-3d)
...
![even and odd numbers on a 2d grid where the components are added](../../assets/45a48bef1b02ca89.png)


![checkerboard pattern on a material](../../assets/1be94a1dbbba6adb.png)
...
![checkerboard pattern on a sphere](../../assets/4e84b03c1b230dcb.png)
...
![scaling checkerboard bigger and smaller](../../assets/5b6a6920a4f1dfec.gif)


## Customizable Colors [🔗︎](#customizable-colors)
...
![colorful checkerboard pattern on a material](../../assets/6d7a2998361cc616.png)
...
You can also find the source code for this shader here: [https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/011_ChessBoard/Chessboard.shader](https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/011_ChessBoard/Chessboard.shader)
