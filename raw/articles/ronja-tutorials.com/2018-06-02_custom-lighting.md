...
url: https://www.ronja-tutorials.com/post/013-custom-lighting/
...
This tutorial will build on the result of the [surface shader basics tutorial](https://www.ronja-tutorials.com/post/005-simple-surface/) and I recommend you to have understood it first.

![Result](../../assets/9a56b44a4d8e7835.png)


## Use Custom Lighting Function [🔗︎](#use-custom-lighting-function)
...
![A model with only global illumination](../../assets/36231e1ec5454d81.png)
...
## Implement Lighting Ramp [🔗︎](#implement-lighting-ramp)
...
![Simple lighting](../../assets/69d2165da879ac2d.png)
...
![A image thats black on the right and black on the left side](../../assets/b4c5109d54dd6cfd.png)
...
![surface thats completely white towards the light source](../../assets/de0e6bfa73d17039.png)
...
![A surface with a hard light cutoff](../../assets/af3beb3affab21e8.png)
...
![A lighting ramp with blue values on the left and red ones on the right](../../assets/9934dae60989328d.png)


![the red/blue ramp applied, the surface has cold shadows](../../assets/a238eb11523e6e67.png)
...
You can also find the source code for this shader here: [https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/013_CustomSurfaceLighting/CustomLighting.shader](https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/013_CustomSurfaceLighting/CustomLighting.shader)
