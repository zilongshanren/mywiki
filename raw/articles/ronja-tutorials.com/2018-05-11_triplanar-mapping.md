...
url: https://www.ronja-tutorials.com/post/010-triplanar-mapping/
...
This tutorial will build upon the [planar mapping shader](https://www.ronja-tutorials.com/post/008-planar-mapping/) which is a unlit shader, but you can use the technique with many shaders, including surface shaders.
![Result](../../assets/dee13d2927826ada.gif)


## Calculate Projection Planes [🔗︎](#calculate-projection-planes)
...
![Add projections from all sides together](../../assets/4f497af15ded6ab5.png)
...
![Why we have to scale the normal with the inverse matrix instead of the regular one](../../assets/8b23ec3c7dc0ee46.png)
...
![The normals as colors](../../assets/83dc9a720ba18111.png)
...
![Illustration of a plane based on asurface normal](../../assets/cee907289ad82ff1.png)
...
![the planar projections added based on normals](../../assets/fb21588c3273e5e0.jpg)
...
![the planar projections added based on normals with normalized blend factors](../../assets/d3340547975e3d07.jpg)
...
![adjusting the blend sharpness](../../assets/004bdfaa942743a5.gif)
...
You can also find the source code for this shader here: [https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/010_Triplanar_Mapping/triplanar_mapping.shader](https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/010_Triplanar_Mapping/triplanar_mapping.shader)
