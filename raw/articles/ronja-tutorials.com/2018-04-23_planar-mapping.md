...
url: https://www.ronja-tutorials.com/post/008-planar-mapping/
...
This tutorial will build on the [simple textured shader](https://www.ronja-tutorials.com/post/004-basic/), but you can use the technique with any shader including surface shaders.

![Result](../../assets/e2bab035851bda89.png)
...
## Adjustable Tiling [🔗︎](#adjustable-tiling)
...
![adjust tiling and offset and watch the material react](../../assets/80e5801bf8860adb.gif)


## Texture Coordinates based on World Position [🔗︎](#texture-coordinates-based-on-world-position)
...
![create a few spheres with the new material and move them around](../../assets/13ef5d9ae9818d6c.gif)
...
You can also find the source code here [https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/008_Planar_Mapping/planar_mapping.shader](https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/008_Planar_Mapping/planar_mapping.shader)
