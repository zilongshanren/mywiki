---
title: Fresnel
url: https://www.ronja-tutorials.com/post/012-fresnel/
...
For this tutorial we will make a surface shader, so if you follow it directly you should know the basics of surface shaders. You can find a explanation of them [here](https://www.ronja-tutorials.com/post/004-basic/). But you can also use a fresnel effect for unlit shaders, giving your objects some smoothness and tangibility without having to implement expensive lighting.

![Material with fresnel effect](../../assets/87988123ec5cae5c.jpg)


## Highlighting one Side of the Model [🔗︎](#highlighting-one-side-of-the-model)
...
You can generate the worldspace normals in non-surface shaders with a simple matrix multiplication, it’s explained in my [triplanar mapping tutorial](https://www.ronja-tutorials.com/post/010-triplanar-mapping/).
...
![A sphere with a dot product](../../assets/ad0c364cd5af01ed.png)


![arrows that show which value the dot product has with relative directions](../../assets/7a1b8bb56880d766.png)
...
![Material dot product added to emissive channel, the bottom is black](../../assets/1c09d0f2a725ca91.png)
...
## Highlighting the outer Parts [🔗︎](#highlighting-the-outer-parts)
...
![Material with highlighted front](../../assets/bf83a7c5cf47083f.png)
...
![Material with white fresnel effect](../../assets/957f2d98a3b10be2.png)


## Add Fresnel Color and Intensity [🔗︎](#add-fresnel-color-and-intensity)
...
![purple fresnel effect](../../assets/87988123ec5cae5c.jpg)
...
![Adjusting the fresnel strength](../../assets/c36cfeb4395260fc.gif)
...
You can also find the source code for this shader here: [https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/012_Fresnel/Fresnel.shader](https://github.com/ronja-tutorials/ShaderTutorials/blob/master/Assets/012_Fresnel/Fresnel.shader)
