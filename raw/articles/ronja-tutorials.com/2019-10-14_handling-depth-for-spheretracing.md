...
url: https://www.ronja-tutorials.com/post/045-spheretracing-depth/
...
tutorial](https://www.ronja-tutorials.com/post/044-spheretracing-shading/) and you should at least understand
[spheretracing basics](https://www.ronja-tutorials.com/post/043-spheretracing-basics/) before you try to understand it.

![](../../assets/9488c6e624b28e89.png)


## Minor adjustments [🔗︎](#minor-adjustments)
...
to the SubShader or Pass section. I also set the Render Type
...
archived this by defining a `hitsurface`
...
calculates the color to `renderSurface`

and defined the samplePoint
...
![](../../assets/7a027bbf5d0ed11b.png)


## Output Custom Depth [🔗︎](#output-custom-depth)
...
result of this also has the
`w`

component which we have to divide by to get regular 3d values. Since
we only care about the depth, we only divide the `z`

component by the
`w`

component and assign the result to the depth output value. Because
