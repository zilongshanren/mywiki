---
title: Voronoi Noise
url: https://www.ronja-tutorials.com/post/028-voronoi-noise/
...
Another form of noise is voronoi noise. For voronoi noise we need a bunch of points, then we generate a pattern based on which point is the closest. This specific implementation of voronoi noise will work based on cells just like most of the previous noise types we explored, this makes it relatively cheap and easy to repeat. To understand this tutorial I recommend you to have at least understood [the basics of shaders in unity](https://www.ronja-tutorials.com/basics/) and how to [generate random values in shaders](https://www.ronja-tutorials.com/post/024-white-noise/).

![](../../assets/d80e8d0d4c575aa8.gif)


Also possible trypophobia warning for this tutorial, visualising distances can look a bit messy.

## Get Cell Values [🔗︎](#get-cell-values)
...
![](../../assets/ddf16b161f520c7f.png)


## Getting the distance to the border [🔗︎](#getting-the-distance-to-the-border)
...
![](../../assets/a9eb39b4b7dc44c7.png)


## Visualising voronoi noise [🔗︎](#visualising-voronoi-noise)
...
Because we defined the cell border distance to be in the same scale as the input value we can get the best results by evaluating how much the input changes in the neighboring pixels. We first get the change of the input by passing the variable to `fwidth`
...
After we calculate the value change we can then use it to blur the edges. We replace the `step`

function with the `smoothstep`

function which will allow us to pass 2 values and it’ll return a value between 0 and 1 just like described earlier. It’s important for us to also calculate 1 minus the result afterwards, because the smoothstep will return 0 if it’s a a border and 1 when it isn’t and we want our varaiable to indicate if it’s a border.
...
![](../../assets/2ca719d4ba6095db.png)


## 3d Voronoi [🔗︎](#3d-voronoi)
