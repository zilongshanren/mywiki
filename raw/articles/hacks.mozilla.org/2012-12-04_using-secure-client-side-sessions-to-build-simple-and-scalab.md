...
title: Using secure client-side sessions to build simple and scalable Node.JS applications
  – A Node.JS Holiday Season, part 3 – Mozilla Hacks - the Web developer blog
...
This is episode 3, out of a total 12, in the

[A Node.JS Holiday Season series]from Mozilla’s Identity team. It covers using sessions for scalable Node.js applications.
...
What that means in practice is that you encrypt and sign the cookie using a server key to keep users from reading or modifying the session data. This is what [client-sessions](https://github.com/mozilla/node-client-sessions) does.

## node-client-sessions

If you use Node.JS, there’s a library available that makes getting started with client-side sessions trivial: [node-client-sessions](https://github.com/mozilla/node-client-sessions). It replaces [Connect](http://www.senchalabs.org/connect/)‘s built-in [session](http://www.senchalabs.org/connect/session.html) and [cookieParser](http://www.senchalabs.org/connect/cookieParser.html) middlewares.
...
Then, you can set properties on the `req.session`
...
While the expiry scheme works fine in most applications (especially when it’s set to a relatively low value), in the case of [Persona](https://login.persona.org), we needed a way for users to immediately revoke their sessions as soon as they learn that they password has been compromised.

This meant keeping a little bit of state on the backend. The way we [made this instant revocation possible](https://github.com/mozilla/browserid/commit/1b0444d85700a951edc74a0bf7ad5581b2cbfedd) was by adding a new token in the user table as well as in the session cookie.
...
If you want to give [client-sessions](https://github.com/mozilla/node-client-sessions) a go, have a look at this [simple demo application](https://github.com/fmarier/node-client-sessions-sample). Then if you find any bugs, let us know via [our bug tracker](https://github.com/mozilla/node-client-sessions/issues).

## Previous articles in the series

This was part three in [a series with a total of 12 posts about Node.js](https://hacks.mozilla.org/category/a-node-js-holiday-season/). The previous ones are:
...
Caio Ribeiro PereiraDecember 5th, 2012 at 05:21François MarierDecember 5th, 2012 at 17:11FrampDecember 5th, 2012 at 07:00François MarierDecember 5th, 2012 at 17:13David MulderDecember 5th, 2012 at 13:31François MarierDecember 5th, 2012 at 17:18SimonJanuary 15th, 2013 at 11:26Erlend OftedalDecember 5th, 2012 at 15:50Lloyd HilaielFebruary 2nd, 2013 at 00:37gggeekJanuary 30th, 2013 at 13:16Erlend OftedalJanuary 31st, 2013 at 02:47Lloyd HilaielFebruary 2nd, 2013 at 00:43NodeDudeMarch 13th, 2013 at 07:27ErlendMarch 13th, 2013 at 08:52NodeDudeMarch 13th, 2013 at 11:36who did thisMarch 20th, 2013 at 13:35StevenApril 3rd, 2013 at 08:52