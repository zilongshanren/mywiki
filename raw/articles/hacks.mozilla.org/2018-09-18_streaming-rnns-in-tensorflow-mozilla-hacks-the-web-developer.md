---
title: Streaming RNNs in TensorFlow – Mozilla Hacks - the Web developer blog
url: https://hacks.mozilla.org/2018/09/speech-recognition-deepspeech/
...
![An alternative architecture that uses a unidirectional RNN in which each time step only depends on the input at that time and the state from the previous step.](../../assets/2a4f4c948375f98c.png)
...
- Accumulate audio samples until there’s enough data to feed to the model (16 time steps in our case, or 320ms).
- Feed through the model, accumulate outputs somewhere.
- Repeat 2 and 3 until data is over.
...
AdamSeptember 22nd, 2018 at 07:36Reuben MoraisSeptember 24th, 2018 at 05:53dannyOctober 11th, 2018 at 01:50Reuben MoraisOctober 18th, 2018 at 12:06LoganOctober 14th, 2018 at 18:15