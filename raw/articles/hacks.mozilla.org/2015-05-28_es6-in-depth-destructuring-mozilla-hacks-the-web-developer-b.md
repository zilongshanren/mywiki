...
SpiderMonkey (Firefox’s JavaScript engine) already has support for most of destructuring, but not quite all of it. [Track SpiderMonkey’s destructuring (and general ES6) support in bug 694100](https://bugzilla.mozilla.org/show_bug.cgi?id=694100).
...
This will just assign variable1 through variableN to the corresponding item in the array. If you want to declare your variables at the same time, you can add a `var`
...
is a misnomer since you can nest patterns as deep as you would like:
...
This may come unexpected, but upon further examination the reason turns out to be simple. When using an object assignment pattern, the value being destructured is [required to be coercible to an Object](https://people.mozilla.org/~jorendorff/es6-draft.html#sec-requireobjectcoercible). Most types can be converted to an object, but

`null`

and `undefined`

may not be converted. When using an array assignment pattern, the value must [have an iterator](https://people.mozilla.org/~jorendorff/es6-draft.html#sec-getiterator).
...
[ECMAScript 6 also defines an iteration protocol](https://hacks.mozilla.org/2015/04/es6-in-depth-iterators-and-the-for-of-loop/), which we talked about earlier in this series. When you iterate over [ Maps (an ES6 addition to the standard library)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map), you get a series of
...
Support for destructuring is under development for Chrome, and other browsers will undoubtedly add support in time. For now, you’ll need to use [Babel](http://babeljs.io/) or [Traceur](https://github.com/google/traceur-compiler#what-is-traceur) if you want to use destructuring on the Web.
...
Kyle SimpsonMay 28th, 2015 at 17:35Josh StrangeMay 28th, 2015 at 20:18Kyle SimpsonMay 29th, 2015 at 12:17Nick FitzgeraldMay 29th, 2015 at 11:35Aesop WolfMay 31st, 2015 at 00:30thelinuxlichMay 28th, 2015 at 18:21DanielMay 28th, 2015 at 20:15Giacomo TagliabueMay 29th, 2015 at 00:47JasonJune 1st, 2015 at 06:10Nick FitzgeraldJune 1st, 2015 at 11:27Simon SpeichJune 3rd, 2015 at 05:47JasonJune 17th, 2015 at 17:29