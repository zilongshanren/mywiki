---
title: Llamafile’s progress, four months in – Mozilla Hacks - the Web developer blog
...
The best place to connect with both the llamafile team at Mozilla and the overall llamafile community is over at our Discord server, which has [a dedicated channel just for llamafile](https://discord.gg/YuMNeuKStr). And of course, your enhancement requests, issues, and PRs are always welcome over at our [GitHub repo](https://github.com/Mozilla-Ocho/llamafile).
