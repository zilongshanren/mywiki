...
otherwise, the second half is also littered with [integer overflows](https://github.com/PacktPublishing/C-Plus-Plus-Memory-Management/blob/9e4c4ea7/chapter12/Vector-better.cpp#L45)
lacking [the appropriate checks](/blog/2024/05/24/), and near the end has some [pointer
overflows](https://github.com/PacktPublishing/C-Plus-Plus-Memory-Management/blob/9e4c4ea7/chapter14/Vector_with_allocator_cpp23.cpp#L118-L119) invalidating the check.) However, I’m grateful for the new
insights, and it’s made me revisit [my own C++ arena allocation](/blog/2024/04/14/). In
...
Caveat: This only works starting in C++20, and strictly with ```
operator
new[](size_t, void *)
```
...
far as I can tell [this is allowed](https://en.cppreference.com/w/cpp/language/lifetime.html#Storage_reuse), even for non-trivial destructors,
...
article, [talked about lifetimes](https://www.youtube.com/watch?v=oZyhq4D-QL4) just a couple weeks later. I
recommend both.