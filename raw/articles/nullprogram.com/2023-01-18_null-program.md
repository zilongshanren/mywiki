...
In [my common SDL2 mistakes listing](/blog/2023/01/08/), the first was about winging it
...
consideration. One is the [pkg-config](https://www.freedesktop.org/wiki/Software/pkg-config/) facility common to unix-like
...
support: [u-config](https://github.com/skeeto/u-config) (“*micro*-config”). It will serve as pkg-config
...
the original from freedesktop.org (2001), and [pkgconf](http://pkgconf.org/) (2011). Both
...
*Update*: It was [pointed out](https://lists.sr.ht/~skeeto/public-inbox/%3C1750680.o7JgDH7DvH%40laptop%3E) that I wouldn’t need the full,
...
into [busybox-w32](https://frippery.org/busybox/) as a new app with little effort…)
...
Since standard C functions are [implemented poorly on Windows](/blog/2021/12/30/), but
...
translations at the Win32 boundaries for paths, [arguments](/blog/2022/02/18/), environment
...
[sizes and subscripts should be signed](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1428r0.pdf). Not only that, pkg-config
...
No! The individual objects do not have [individual lifetimes](https://www.rfleury.com/p/untangling-lifetimes-the-arena-allocator) due
...
, modeled loosely after a [Plan 9 ](https://9p.io/sys/doc/comp.html)`bio`
