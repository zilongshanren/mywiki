...
to matter, but I hate [leaving behind avoidable quadratic algorithms](https://randomascii.wordpress.com/category/quadratic/).
...
Because [the standard library has little useful for us](/blog/2023/02/11/), I am
...
tokens, so we’ll [need a slice](/blog/2025/06/26/). Fields also have an offset within
...
Finally down to business: [cut up the list](/blog/2025/03/02/) and build the token
...
[concatenate](/blog/2024/05/25/) to a single string at compile time so that it only needs
