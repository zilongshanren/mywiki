...
allocated — that is, when it [cannot be avoided entirely](/blog/2018/06/10/). The C
standard never laid down a convention — [perhaps for the better](/blog/2023/02/11/) —
...
are even [tricks to bind a context pointer](/blog/2017/01/08/) to the callback. It
...
arena allocator](/blog/2023/09/27/). To demonstrate, consider this fictional string
...
signed](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1428r0.pdf), and we’re now breaking away from the standard library
...
This was noticed in C++, and WG21 added [sized deallocation](https://isocpp.org/files/papers/n3778.html) in
...
later gained [a similar ](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2699.htm)`free_sized`
...
class. [Size-class freelists compose well with arenas](https://www.youtube.com/watch?v=LIb3L4vKZ7U), and an
...
First up is [uthash](https://troydhanson.github.io/uthash/userguide.html#_hooks), a popular, easy-to-use, intrusive hash table:
...
Next is the venerable [zlib](https://www.zlib.net/manual.html). It has function pointers with these
...
Finally there’s the [Lua programming language](https://www.lua.org/manual/5.4/manual.html#lua_Alloc) with this economical,
