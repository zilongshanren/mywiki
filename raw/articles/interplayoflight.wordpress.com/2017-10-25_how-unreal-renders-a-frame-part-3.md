---
title: How Unreal Renders a Frame part 3
url: https://interplayoflight.wordpress.com/2017/10/25/how-unreal-renders-a-frame-part-3/
...
Great work, my onlyu complaint is that the images are too small to appreciate some of the details.

Thanks for expossing so much info.

Sorry about that, something went wrong when uploading the blog post through Word. I have now changed all the images to be clickable.

Great series or articles!

Some of it definitely went over my head but I think this is the type of thing that takes multiple reads and following up on external resources.

Thanks!

Great post! One question I have is how do they get rid of normal precision artifacts for glossy surfaces? They only use a RGB10 for the normals with no compression, which should cause scaly speculars. Is the errors smoothed by temporal re-projection and bloom?

Good question, I am not sure, it is worth investigating. Maybe temporal AA helps a bit indeed.