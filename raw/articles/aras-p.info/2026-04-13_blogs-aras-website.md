---
title: Blogs · Aras' website
url: https://aras-p.info/blog/
...
- The points
*might* need to be larger than a pixel, if you zoom in.
...
*crazily* contended – but it is around 5x faster that rasterization across the board.
