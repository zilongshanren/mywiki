---
title: Voronoi, Hashing and OSL · Aras' website
url: https://aras-p.info/blog/2025/06/13/Voronoi-Hashing-and-OSL/
...
![](../../assets/c0a1b5736023cc76.png)

![](../../assets/e1b74c370422226c.png)

![](../../assets/449686f0489cb1d6.png)

![](../../assets/5a5141e1b67cc613.png)

![](../../assets/6f260d8811ad9bb0.jpg)
...
If you are using hash functions from the 1990s, try some of the more modern ones! They might be both simpler and the same or better quality. Hash functions from several decades ago
...
, we need`hash_int3_to_float3`

. This works around the lack of bit casts in OSL. - We can work around lack of unsigned integers with a slight modification to PCG hash, that just operates on signed integers instead.
OSL
*can*do multiplications, XORs and bit shifts, just only on signed integers. Fine with us!
...
that take float as input, and produce a float output. And… yup, they just

*happened*to use exactly the same Jenkins Lookup3 hash function underneath. Happy coincidence? One implementation copying what the other was doing? I don’t know.
...
*does*change the actual resulting Voronoi pattern, e.g. before and after:

![](../../assets/2a45293c9d3ae8f6.png)


![](../../assets/2a45293c9d3ae8f6.png)

![](../../assets/f93494d38b43f302.png)
...
*Actually*learned about how Voronoi/Worley noise code works, instead of only casually hearing about it.- Learned that various nodes within Blender have
*four*separate implementations, that all have to match in behavior. - Learned that there is a shading language, in 2025, that does not have unsigned integers :)
