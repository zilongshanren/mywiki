---
title: Incoming Breaking Changes - New Maths API | PlayCanvas Blog
url: https://blog.playcanvas.com/new-maths-api
author: Dave Evans
...
![Maths](../../assets/d5a004b72c3bf6d8.png)
...
## What does this mean for you?[](https://blog.playcanvas.com#what-does-this-mean-for-you)
...
As you can see we now support chaining vector operations together. This makes the code more concise, and also more readable. If you read through the line you can see we `subtract`
...
## When is it going to break?[](https://blog.playcanvas.com#when-is-it-going-to-break)
