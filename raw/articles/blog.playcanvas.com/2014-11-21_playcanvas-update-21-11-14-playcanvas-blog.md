---
title: PlayCanvas Update 21/11/14 | PlayCanvas Blog
url: https://blog.playcanvas.com/playcanvas-update-211114
...
#### New Particle System[](https://blog.playcanvas.com#new-particle-system)
...
#### Project Pages[](https://blog.playcanvas.com#project-pages)
...
#### Watching and Starring Projects[](https://blog.playcanvas.com#watching-and-starring-projects)
...
### Graphics[](https://blog.playcanvas.com#graphics)

**Theres so much new graphics stuff to announce, it gets its own section. Crazy, we know!**

- We have a completely
**new shader subsystem**. - Support for
**far more lights in a scene**. **Point lights can now cast shadows**(like spot and directional lights). See cast shadows option in light component UI for point lights.- We added
**Fresnel reflection**. Currently still a beta feature this is only enable via a script. - You can now use
**physically correct falloff**mode for point and spot lights. See falloff mode in the light component UI. Current mode is linear, new mode is inverse squared. **Gamma correction**is now enabled by default in scenes. For older projects you can turn this on in your scene settings.

### Other News[](https://blog.playcanvas.com#other-news)

#### Propsplanet[](https://blog.playcanvas.com#propsplanet)
