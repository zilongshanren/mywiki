---
title: What's new? HTML Assets, New Gizmos, Viewport improvements | PlayCanvas Blog
url: https://blog.playcanvas.com/whats-new-html-assets-new-gizmos-viewport-improvements
author: Dave Evans
...
## 3D view updates[](https://blog.playcanvas.com#3d-viewupdates)
...
## HTML and CSS assets[](https://blog.playcanvas.com#html-and-css-assets)
...
## Collaborative editing[](https://blog.playcanvas.com#collaborative-editing)
...
## Project Export / Import[](https://blog.playcanvas.com#project-export--import)
...
## Custom Loading Screens[](https://blog.playcanvas.com#custom-loading-screens)
...
## The full list[](https://blog.playcanvas.com#the-full-list)
...
- Added gizmo for collision component of
`asset`

type, now it renders asset on top with overlay - Improved gizmos for spot lights.
...
visible on top right corner of each asset in an asset panel, when asset is considered as "possibly unused". - Added
`skyboxIntensity`

and`skyboxMip`

selectors to Scene Settings. - Added UV Selector for textures in material inspector
