---
title: Changes for 25th November | PlayCanvas Blog
url: https://blog.playcanvas.com/changes-for-25th-november
author: Dave Evans
...
## PlayCanvas Designer[](https://blog.playcanvas.com#playcanvas-designer)

**Fog Settings**- Check out the Scene Settings under the View Menu and now you can control the fog type and amount in your scene.**Nudge Controls**- Vector properties can now be nudged using the up and down arrow keys

## PlayCanvas Engine[](https://blog.playcanvas.com#playcanvas-engine)

**Internet Explorer 11 support!**- [BREAKING] Script Components have changed format, if you are creating script components in your code you'll need to update your scripts
