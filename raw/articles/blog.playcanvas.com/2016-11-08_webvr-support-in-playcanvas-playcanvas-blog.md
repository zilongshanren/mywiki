---
title: WebVR support in PlayCanvas | PlayCanvas Blog
url: https://blog.playcanvas.com/webvr-support-in-playcanvas
author: Dave Evans
...
## PlayCanvas WebVR[](https://blog.playcanvas.com#playcanvas-webvr)

### Optimized Engine Support[](https://blog.playcanvas.com#optimized-engine-support)
...
![VR Performance Comparison](../../assets/5c68cb9b36816e1d.jpg)


### Polyfill for unsupported platforms[](https://blog.playcanvas.com#polyfill-for-unsupported-platforms)
...
### Tutorials and Documentation[](https://blog.playcanvas.com#tutorials-and-documentation)

PlayCanvas is renowned for its extensive documentation and VR is no different. [Basic instructions](https://developer.playcanvas.com/user-manual/xr/vr/), [API reference](https://api.playcanvas.com/engine/classes/XrManager.html) and [specific optimization tips](https://developer.playcanvas.com/user-manual/xr/optimizing-webxr/), we've got it all.

### Samples and Starter Kits[](https://blog.playcanvas.com#samples-and-starter-kits)
