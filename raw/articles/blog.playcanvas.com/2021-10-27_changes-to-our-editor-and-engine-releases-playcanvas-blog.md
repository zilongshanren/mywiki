---
title: Changes to our Editor and Engine Releases | PlayCanvas Blog
url: https://blog.playcanvas.com/changes-to-our-editor-and-engine-releases
author: Steven Yau
...
### Minor and patch versions updates[](https://blog.playcanvas.com#minor-and-patch-versions-updates)
...
### Renaming Engine's GitHub 'master' branch to 'dev'[](https://blog.playcanvas.com#renaming-engines-github-master-branch-to-dev)
...
### Separate Engine releases from the Editor[](https://blog.playcanvas.com#separate-engine-releases-from-the-editor)
...
### Feedback[](https://blog.playcanvas.com#feedback)
