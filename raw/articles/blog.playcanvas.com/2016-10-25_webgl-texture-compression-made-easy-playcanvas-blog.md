---
title: WebGL Texture Compression Made Easy | PlayCanvas Blog
url: https://blog.playcanvas.com/webgl-texture-compression-made-easy
...
### Summary[](https://blog.playcanvas.com#summary)

**One-click texture compression**for DXT, PVR and ETC1- Achieve at least
**6 times compression**of all texture data in your WebGL apps **Most optimal image format selected**for device running a PlayCanvas app
