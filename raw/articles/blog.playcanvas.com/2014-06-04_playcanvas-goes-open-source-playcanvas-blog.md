---
title: PlayCanvas goes open source | PlayCanvas Blog
url: https://blog.playcanvas.com/playcanvas-goes-open-source
author: Dave Evans
...
### Why open source, why now?[](https://blog.playcanvas.com#why-open-source-why-now)
...
### So, this engine? What is it?[](https://blog.playcanvas.com#so-this-engine-what-is-it)
...
**Graphics:**model loading, per-pixel lighting, shadow mapping, post effects**Physics:**rigid body simulation, ray casting, joints, trigger volumes, vehicles**Animation:**keyframing, skeletal blending, skinning**Audio engine:**2D and 3D audio sources**Input devices:**mouse, keyboard, touch and gamepad support**Entity-component system:**high level game object management

### Design Goals[](https://blog.playcanvas.com#design-goals)
...
#### Simple Yet Powerful[](https://blog.playcanvas.com#simple-yet-powerful)
...
#### Need For Speed[](https://blog.playcanvas.com#need-for-speed)
...
### Powering Awesome Projects[](https://blog.playcanvas.com#powering-awesome-projects)
...
**Accessible**- Using any device with a web browser, plug in a URL and instantly access simple, intuitive yet powerful tools.**Collaborative**- See what you teammates are working on in real-time or just sit back and watch a game as it’s built live before your eyes.**Social**- Making games is easier with the help of others. Be part of an online community of developers like you.
...
### Speaking of Games[](https://blog.playcanvas.com#speaking-of-games)
...
![SWOOOP](../../assets/24f76b5086c3f765.jpg)
...
### Get Involved[](https://blog.playcanvas.com#get-involved)
