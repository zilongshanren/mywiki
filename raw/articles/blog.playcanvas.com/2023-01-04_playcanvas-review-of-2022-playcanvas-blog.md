---
title: PlayCanvas Review of 2022 | PlayCanvas Blog
url: https://blog.playcanvas.com/playcanvas-review-of-2022
author: Steven Yau
...
### The fantastic work done by you[](https://blog.playcanvas.com#the-fantastic-work-done-by-you)
...
![WebGPU Grabpass](../../assets/41a080fc17a452df.gif)

![WebGPU Clustered Lighting](../../assets/e4127737c22b7c4f.gif)
...
![Space Rocks](../../assets/65a77c29a086e84b.gif)

![Pool Demo](../../assets/ec37a6c3d14a1bf4.gif)

### glTF Viewer 2.0 with AR support[](https://blog.playcanvas.com#gltf-viewer-20-with-ar-support)
...
[Infrastructure upgrades across the board](https://eng.snap.com/playcanvas-backend-infrastructure)with benefits to all users including:- Faster download speeds for published build zips across the world.
...
[More powerful Scene Hierarchy Search](https://github.com/playcanvas/editor/releases/tag/v1.21.81)that searches components and script names.[Creating Texture Tool](https://github.com/playcanvas/editor/releases/tag/v1.21.61)to inspect textures and convert HDRIs to/from cubemaps (also open source!).- Adding GitHub sign-in.
...
### Thank You[](https://blog.playcanvas.com#thank-you)
