---
title: Compressing Gaussian Splats | PlayCanvas Blog
...
### Introduction[](https://blog.playcanvas.com#introduction)

[ 3D Gaussian Splatting](https://repo-sam.inria.fr/fungraph/3d-gaussian-splatting/) is a new method for digitizing and rendering real world objects. With gaussian splatting, you can digitize a scene from a few photos using services like

[Luma Labs](https://lumalabs.ai/)or

[Polycam](https://poly.cam/). These services take the set of photos and generate a 3d Gaussian Splat scene in

[PLY format](https://en.wikipedia.org/wiki/PLY_(file_format)).

For example, this is a Gaussian Splat scene rendered in PlayCanvas.

### What is a Splat?[](https://blog.playcanvas.com#what-is-a-splat)
...
![Splat Example](../../assets/f8686d3c0bfd289a.gif)
...
### Engine Support[](https://blog.playcanvas.com#engine-support)
...
### PLY Format[](https://blog.playcanvas.com#ply-format)
...
For example, the original `guitar.ply`

scene file takes **132.8 MB** (**32 MB** excluding spherical harmonic data).

### Compressed PLY Format[](https://blog.playcanvas.com#compressed-ply-format)
...
As a result, the compressed version of `guitar.ply`

takes only **8.7 MB**.

### Do It Yourself[](https://blog.playcanvas.com#do-it-yourself)
...
### Summary and Future[](https://blog.playcanvas.com#summary-and-future)
...
### References[](https://blog.playcanvas.com#references)
