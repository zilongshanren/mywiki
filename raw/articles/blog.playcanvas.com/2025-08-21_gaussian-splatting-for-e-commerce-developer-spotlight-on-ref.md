---
title: Gaussian Splatting for E-Commerce - Developer Spotlight on Reflct | PlayCanvas
  Blog
url: https://blog.playcanvas.com/gaussian-splatting-for-e-commerce-developer-spotlight-on-reflct
...
*Willie*: Sure, when you drag in your `.ply`
...
You just do that a few times to set all the points in your scene where you want to direct the user's attention. Then you create a shareable link, or integrate it with your site using our React library or Shopify app. If you’re using our Shopify app, you can add the `productHandle`

to the view metadata and it will automatically pull the product details into the side panel.
...
![Reflct Memory Savings](../../assets/0381d506196e485a.png)


The performance gains have been massive. If you load the same `.ply`
