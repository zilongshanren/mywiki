---
title: PLAYHACK November - Adding Tank Controls | PlayCanvas Blog
url: https://blog.playcanvas.com/playhack-november-adding-tank-controls
author: Dave Evans
...
## Tank Controls[](https://blog.playcanvas.com#tank-controls)
...
### Setting up the Physics[](https://blog.playcanvas.com#setting-up-the-physics)
...
### Keyboard input[](https://blog.playcanvas.com#keyboard-input)
...
This script is attached to the **Tank** entity. It's pretty self-explanatory. Each frame, `update()`

is called. This function checks to see if the any of the arrow keys on the keyboard have been pressed. If they have a force or torque is applied to the rigidbody attached to the entity.
