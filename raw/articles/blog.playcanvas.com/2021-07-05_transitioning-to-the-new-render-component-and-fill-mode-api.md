---
title: Transitioning to the New Render Component and Fill Mode API | PlayCanvas Blog
url: https://blog.playcanvas.com/transitioning-to-the-new-render-component-and-fill-mode-api
author: Steven Yau
...
### Moving from Model Component model import pipeline to new Render Component[](https://blog.playcanvas.com#moving-from-model-component-model-import-pipeline-to-new-render-component)
...
![Import Hierarchy Preview](../../assets/9d8c1f4e28c5424d.jpg)
...
[developer.playcanvas.com](https://developer.playcanvas.com)tutorials will be updated to use Render Component ([playcanvas.github.io](https://playcanvas.github.io)engine examples have already been updated).- The template projects (Blank Project, Model Viewer Starter Kit, VR Starter Kit) will be updated to use Render Component.
- User Manual updates and mitigation steps from using the Model Component to Render Component pipelines.

### Breaking change to PlayCanvas Fill Mode API[](https://blog.playcanvas.com#breaking-change-to-playcanvas-fill-mode-api)
...
[Forum: A Complete PlayCanvas scene inside a div](https://forum.playcanvas.com/t/a-complete-playcanvas-scene-inside-div-tags/18461)[Forum: PlayCanvas within a div](https://forum.playcanvas.com/t/solved-playcanvas-within-a-div/10492)[Forum: Embedding PlayCanvas into a webpage without iframe](https://forum.playcanvas.com/t/embedding-playcanvas-into-a-webpage-without-iframe/17246)
...
### Questions and Feedback[](https://blog.playcanvas.com#questions-and-feedback)
