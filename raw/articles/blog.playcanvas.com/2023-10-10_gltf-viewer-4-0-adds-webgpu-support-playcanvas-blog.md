---
title: glTF Viewer 4.0 Adds WebGPU Support | PlayCanvas Blog
url: https://blog.playcanvas.com/gltf-viewer-adds-webgpu-support
...
![glTF Viewer 4.0](../../assets/ddf645337babc7ad.png)


["Cyber Samurai"](https://skfb.ly/ooZKG) by KhoaMinh is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
...
#### New WebGPU Renderer[](https://blog.playcanvas.com#new-webgpu-renderer)
...
#### Enhanced WebXR AR Mode[](https://blog.playcanvas.com#enhanced-webxr-ar-mode)
...
#### Frame Selected Node[](https://blog.playcanvas.com#frame-selected-node)
...
#### Better Immersion with Projective Sky Dome[](https://blog.playcanvas.com#better-immersion-with-projective-sky-dome)

["130"](https://skfb.ly/6R9Ow) by mononofu is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
...
#### Debug and Inspect with Render Mode[](https://blog.playcanvas.com#debug-and-inspect-with-render-mode)
...
#### Enhanced Realism with VSM Shadows[](https://blog.playcanvas.com#enhanced-realism-with-vsm-shadows)
...
### Join Our Open Source Community[](https://blog.playcanvas.com#join-our-open-source-community)
