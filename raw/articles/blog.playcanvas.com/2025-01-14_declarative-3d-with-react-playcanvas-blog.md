---
title: Declarative 3D with React | PlayCanvas Blog
url: https://blog.playcanvas.com/declarative-3d-with-playcanvas-react
author: Mark Lundin
...
Today we're proud to announce the release of ** PlayCanvas React**, a new declarative way to build 3D content using
...
### What does this look like?[](https://blog.playcanvas.com#what-does-this-look-like)

With **@playcanvas/react** you create a scene using entities and components, just like you would in the PlayCanvas Editor or Engine. Entities have position, rotation and scale. They're the building blocks of your scene. Components on the other hand add behavior to an entity. For example, adding a `<Render/>`

component to an entity allows it to render a mesh.
...
### Why React?[](https://blog.playcanvas.com#why-react)
...
### What about the Editor and Engine?[](https://blog.playcanvas.com#what-about-the-editor-and-engine)
...
### A new step for 3D[](https://blog.playcanvas.com#a-new-step-for-3d)
...
![Snap AI](../../assets/e542ad8e8a68168a.gif)


To get started you can follow the [installation and getting started guide](https://playcanvas-react.vercel.app/docs/installation), then check out the ** repo** and explore some of the

**in the live playground.**

[examples](https://playcanvas-react.vercel.app/examples)Happy coding!