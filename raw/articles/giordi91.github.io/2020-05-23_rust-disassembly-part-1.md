...
url: https://giordi91.github.io/post/disassemlbyrust1/
...
Table of contents:What do some Rust features compile to?
...
we see a first addition followed by an `adc`

instruction, which takes care of adding the carry flag as well in case it was set.
Pretty cool!
...
is not needed. The compiler is merely shifting the pointer to where we wish to read: `[rdi + 8]`

, if we decided to access the second element we would see : `[rdi + 4]`
...
First of all, let me say I love how it is literally called panic, second is the first time I meet the `ud2`
...
After the publishing of the blog post, [Phil Dennis-Jordan](https://twitter.com/pmjordan)
...
[PR](https://github.com/rust-lang/rust/pull/45920)
implementing it.
