---
title: 云风的 BLOG
url: https://blog.codingnow.com/2010/11/
...
对于有 C 基础的同学，比如我，学习 Go 毫不费力。按[这篇文章](http://golang.org/doc/go_tutorial.html)的指引即可。Rob Pike 的三日教程 PPT ，我心急，用了一个下午就看完了，并且做完了练习。
...
说一下我的练手项目。我用 Go 重新实现了[处理多连接的服务器](http://blog.codingnow.com/2006/04/iocp_kqueue_epoll.html)。当然，现在的设计方案和几年前写 blog 时的方案有略微的不同。
