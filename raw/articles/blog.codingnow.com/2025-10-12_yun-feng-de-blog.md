---
title: 云风的 BLOG
url: https://blog.codingnow.com/2025/10/
...
桌游 [Deep Future](https://github.com/cloudwu/deepfuture)（深远未来）开发告一段落，我为它创建了一个 [itch.io 的页面](https://cloudwu.itch.io/deep-future) 发布第一个试玩版本。接下来的 bugfix 会在 github 继续，等积累一定更新后再发布下一个小版本。

这是一个兴趣驱动的项目。[正如上一篇 blog](https://blog.codingnow.com/2025/08/gamedev.html) 中写到，驱使我写它的一大动力是在实践中探索游戏开发的难题。写这么一篇总结就是非常必要的了。
...
在 8 月的前两周，开发工作更多倾向于 [soluna](https://github.com/cloudwu/soluna) ：
...
[设置窗口标题 api 的多线程竞争引起的死锁](https://blog.codingnow.com/2025/08/setwindowtext_deadlock.html)。
...
- 完善游戏存档
- 实现文明卡和奇迹
- 制作主界面，增加多游戏文件支持和语言切换的交互（之前只提供命令行切换）
- 卡片随机命名
- 实现输入控件以及玩家自定义卡片名称
- 将玩家游戏过程组织成文本供回顾游戏历史
