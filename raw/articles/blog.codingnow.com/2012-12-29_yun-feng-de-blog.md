---
title: 云风的 BLOG
url: https://blog.codingnow.com/2012/12/
...
三个人对同一个房间竞价。这种情况比较好解决，我们直接让出价最少的人出局。然后出价最高的人得到这间房间，其价格是前两个价位的平均值。 接下来的问题就回到了两个人选两个房间的问题了。

有两个人对同一个房间竞价，另一个人选了别的房间。这种情况也好解决，直接让选相同房间的两人中价高者得，价格是两者平均值。

三个人各选了不同的房间。这种情况不太好处理，下面仔细分析。
