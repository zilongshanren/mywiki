...
url: https://blog.yiningkarlli.com/2025/05/wdas-photoshow.html
...
Today I have several cameras, a bunch of weird and fun and interesting lenses that I have collected over the years, and I take a *lot* of photos every year (which has only ramped up even more after I became a dad myself).
...
I color grade my photos for both SDR and HDR; if you are using a device/browser that supports HDR 1 , a toggle will appear below giving the ability to enable HDR on this page.
Give it a try!
...
- Chrome 87 or newer, or Edge 87 or newer, on Windows 10 or newer, running on any PC with a compatible DisplayHDR-1000 or higher display (examples: any monitor on
[this list](https://www.displayninja.com/hdr-monitor-list/)). You may also need to adjust HDR settings in Windows. - Chrome 87 or newer on Android 14 or newer, running on devices with an Android Ultra HDR compatible display (examples: Google Pixel 8 generation or newer, Samsung Galaxy S21 generation or newer, OnePlus 12 or newer, and various others).
...
[keyboard_return](https://blog.yiningkarlli.com#2025-05-11-photoshow-footnote-1-backlink)