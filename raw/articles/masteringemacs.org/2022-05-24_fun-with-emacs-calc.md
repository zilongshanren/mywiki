...
Jon over at [Irreal’s Emacs blog](http://irreal.org/blog/?p=795) posted an interesting solution to a challenge raised by [Xah Lee](http://xahlee.blogspot.com/2012/04/programing-problem-decimalize-latitude.html):
...
First off, I’m not sure Xah’s example answer is entirely correct; my understanding of latitude and longitude is limited to what I can google, and if I type the original degrees, minutes and seconds into [this tool by the U.S. FCC](http://transition.fcc.gov/mb/audio/bickel/DDDMMSS-decimal.html) it returns `37.44345 6.25396`
