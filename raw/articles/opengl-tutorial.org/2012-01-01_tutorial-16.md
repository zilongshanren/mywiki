...
- The View matrix rotates the world so that in camera space, the light direction is -Z (would you like to re-read
[Tutorial 3](http://www.opengl-tutorial.org/beginners-tutorials/tutorial-3-matrices/)?) - The Model matrix is whatever you want.
...
![](../../assets/14460a0c8438f689.png)


![](../../assets/6ae9d8005ec9dfcc.png)
