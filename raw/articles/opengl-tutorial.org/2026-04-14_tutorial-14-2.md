---
title: Туторіал 14
url: http://www.opengl-tutorial.org/uk/intermediate-tutorials/tutorial-14-render-to-texture/
...
це GL_COLOR_ATTACHMENT*i*, що в нашому випадку *renderedTexture*.
...
тому що`DrawBuffers[1] = {GL_COLOR_ATTACHMENT0}`

- GL_COLOR_ATTACHMENT0 має приєднане
*renderedTexture*- сюди буде записуватись колір. - Іншими словами, Ви можете замінити
`GL_COLOR_ATTACHMENT0`

на`GL_COLOR_ATTACHMENT2`
...
на [glTexImage2DMultisample](http://www.opengl.org/sdk/docs/man3/xhtml/glTexImage2DMultisample.xml) в C++ коді та `sampler2D`
...
замість`glViewport(0,0,1024,768);`
