...
url: http://www.opengl-tutorial.org/uk/intermediate-tutorials/billboards-particles/particles-instancing/
...
Як було пояснено в [Туторіалі 10](http://www.opengl-tutorial.org/uk/intermediate-tutorials/tutorial-10-transparency/), Вам потрібно сортувати напівпрозорі об’єкти від найдальших до найближчих, що б вони правильно “змішались”.
...
Ви можете анімувати текстури Ваших частинок, використовуючи атлас текстур. Додамо “вік частинки” до даних про її позицію і в шейдері розрахуємо UV координати як ми це робили в [туторіалі про 2D шрифти](http://www.opengl-tutorial.org/uk/intermediate-tutorials/tutorial-11-2d-text/). Атлас текстур виглядає наступним чином:
...
Однак, Вам потрібно буде взяти зразки з Z-буфера, що неможливо для “нормального” Z-буферу. Вам потрібно намалювати Вашу сцену в [render target](http://www.opengl-tutorial.org/uk/intermediate-tutorials/tutorial-14-render-to-texture/). Інший варіант - можна скопіювати Z-буфер з одного фреймбуферу в інший за допомогою `glBlitFramebuffer`
