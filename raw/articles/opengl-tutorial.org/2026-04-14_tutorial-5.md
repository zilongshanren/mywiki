...
[About UV coordinates](http://www.opengl-tutorial.org#about-uv-coordinates)[Loading .BMP images yourself](http://www.opengl-tutorial.org#loading-bmp-images-yourself)[Using the texture in OpenGL](http://www.opengl-tutorial.org#using-the-texture-in-opengl)[What is filtering and mipmapping, and how to use them](http://www.opengl-tutorial.org#what-is-filtering-and-mipmapping-and-how-to-use-them)[How to load texture with GLFW](http://www.opengl-tutorial.org#how-to-load-texture-with-glfw)[Compressed Textures](http://www.opengl-tutorial.org#compressed-textures)[Conclusion](http://www.opengl-tutorial.org#conclusion)[Exercices](http://www.opengl-tutorial.org#exercices)[References](http://www.opengl-tutorial.org#references)
...
![](../../assets/d0c7102424ddfd33.png)


and a zoomed-in version :

![](../../assets/66e797c2e75ec519.png)
...
- Download
[The Compressonator](http://gpuopen.com/gaming-product/compressonator/), an AMD tool - Load a Power-Of-Two texture in it
- Generate mipmaps so that you won’t have to do it on runtime
- Compress it in DXT1, DXT3 or in DXT5 (more about the differences between the various formats on
[Wikipedia](http://en.wikipedia.org/wiki/S3_Texture_Compression)) :

![](../../assets/cadd11de2893f89f.png)
