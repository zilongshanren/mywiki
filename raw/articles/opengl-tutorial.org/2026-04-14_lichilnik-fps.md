---
title: Лічильник FPS
url: http://www.opengl-tutorial.org/uk/miscellaneous/an-fps-counter/
...
Цей код доступний в всіх туторіалах, починаючи з [Туторіал 9 : VBO індекси](http://www.opengl-tutorial.org/intermediate-tutorials/tutorial-9-vbo-indexing/); дивіться [tutorial09_vbo_indexing/tutorial09.cpp](https://github.com/opengl-tutorials/ogl/blob/master/tutorial09_vbo_indexing/tutorial09.cpp#L142) . Інші інструменти вимірювання продуктивності [Інструменти - Відлагоджувач](http://www.opengl-tutorial.org/uk/miscellaneous/useful-tools-links/#debugging-tools).