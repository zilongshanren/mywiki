...
[Solution #1 : The 2D way](http://www.opengl-tutorial.org#solution-1--the-2d-way)[Solution #2 : The 3D way](http://www.opengl-tutorial.org#solution-2--the-3d-way)[Solution #3 : The fixed-size 3D way](http://www.opengl-tutorial.org#solution-3--the-fixed-size-3d-way)[Solution #4 : Vertical rotation only](http://www.opengl-tutorial.org#solution-4--vertical-rotation-only)
