---
title: Tutorial 17
url: http://www.opengl-tutorial.org/intermediate-tutorials/tutorial-17-quaternions/
...
[Foreword: rotation VS orientation](http://www.opengl-tutorial.org#foreword-rotation-vs-orientation)[Euler Angles](http://www.opengl-tutorial.org#euler-angles)[Quaternions](http://www.opengl-tutorial.org#quaternions)[So, which one should I choose ?](http://www.opengl-tutorial.org#so-which-one-should-i-choose-)[Other resources](http://www.opengl-tutorial.org#other-resources)[Cheat-sheet](http://www.opengl-tutorial.org#cheat-sheet)[How do I know if two quaternions are similar ?](http://www.opengl-tutorial.org#how-do-i-know-if-two-quaternions-are-similar-)[How do I apply a rotation to a point ?](http://www.opengl-tutorial.org#how-do-i-apply-a-rotation-to-a-point-)[How do I interpolate between 2 quaternions ?](http://www.opengl-tutorial.org#how-do-i-interpolate-between-2-quaternions-)[How do I cumulate 2 rotations ?](http://www.opengl-tutorial.org#how-do-i-cumulate-2-rotations-)[How do I find the rotation between 2 vectors ?](http://www.opengl-tutorial.org#how-do-i-find-the-rotation-between-2-vectors-)[I need an equivalent of gluLookAt. How do I orient an object towards a point ?](http://www.opengl-tutorial.org#i-need-an-equivalent-of-glulookat-how-do-i-orient-an-object-towards-a-point-)[How do I use LookAt, but limit the rotation at a certain speed ?](http://www.opengl-tutorial.org#how-do-i-use-lookat-but-limit-the-rotation-at-a-certain-speed-)[How do I…](http://www.opengl-tutorial.org#how-do-i)
...
- The books on
[Useful Tools & Links](http://www.opengl-tutorial.org/miscellaneous/useful-tools-links/)! - As old as it can be, Game Programming Gems 1 has several awesome articles on quaternions. You can probably find them online too.
- A
[GDC presentation](http://www.essentialmath.com/GDC2012/GDC2012_JMV_Rotations.pdf)on rotations - Ogre3D’s
[FAQ on quaternions](http://www.ogre3d.org/tikiwiki/Quaternion+and+Rotation+Primer). Most of the 2nd part is ogre-specific, though. - Ogre3D’s
[Vector3D.h](https://bitbucket.org/sinbad/ogre/src/3cbd67467fab3fef44d1b32bc42ccf4fb1ccfdd0/OgreMain/include/OgreVector3.h?at=default)and[Quaternion.cpp](https://bitbucket.org/sinbad/ogre/src/3cbd67467fab3fef44d1b32bc42ccf4fb1ccfdd0/OgreMain/src/OgreQuaternion.cpp?at=default)
