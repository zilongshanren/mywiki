---
title: Tutorial 7
url: http://www.opengl-tutorial.org/beginners-tutorials/tutorial-7-model-loading/
...
is a comment, just like // in C++- usemtl and mtllib describe the look of the model. We won’t use this in this tutorial.
- v is a vertex
