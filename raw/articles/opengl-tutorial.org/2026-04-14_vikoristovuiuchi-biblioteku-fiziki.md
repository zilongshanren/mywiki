...
url: http://www.opengl-tutorial.org/uk/miscellaneous/clicking-on-objects/picking-with-a-physics-library/
...
![](../../assets/3983929d36c7698e.png)


NDC це куб, 2*2*2 з центром в початку координат, в цьому просторі, промінь йде “через мишу” є просто прямою лінією, перпендикулярною до ближньої площини. Це робить `lRayStart_NDC`

та `lEndStart_NDC`

такими, що легко розраховуються.
