---
title: The AI of Creatures - Alan Zucconi
...
![](../../assets/14bb6d822c8f0f5d.png)

![](../../assets/f9cf1fc0a9591339.png)

![](../../assets/8201b9772afe273e.png)
...
![](../../assets/d4522977523e31b6.png)

You can have a closer look at a creature’s brain using this spreadsheet: [Brain Structure](https://docs.google.com/spreadsheets/d/1vgoUpvlNYTv3pwZfzp6z9FUx6mB0dnDh0jcPB1h_Yp4/edit?usp=sharing).
...
That paper, titled [Creatures: Artificial Life Autonomous Software Agents for Home Entertainment](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.81.1278&rep=rep1&type=pdf), is a good starting point if you want to know how hard Creatures really tries not just to simulate life but to create life itself.
...
“*In the end, it doesn’t matter—*wrote the magazine [Next Generation](https://archive.org/details/NextGeneration35Nov1997/page/n207/mode/2up?q=creatures) in 1997—*Some will doubtless find the appeal elusive, but Creatures still offers one of the most obsessive and entertaining experiences anyone can have in front of the computer.*“
