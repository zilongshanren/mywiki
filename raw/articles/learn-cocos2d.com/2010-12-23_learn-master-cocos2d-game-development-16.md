...
url: http://www.learn-cocos2d.com/knowledge-base/cocos2d-iphone-faq/learn-cocos2d-public-content/manual/cocos2d-general/14813-how-to-get-a-sprites-bounding-box-bounding-rectangle-with-code/14814/resolve-true/
author: Max says
...
[FAQ: cocos2d for iPhone](http://www.learn-cocos2d.com/knowledge-base/cocos2d-iphone-faq/learn-cocos2d-public-content/manual/cocos2d-general/): How to test intersection of rotated rectangles?
...
![](../../../../../../../../features/programming/2dRotatedRectCollision/fig4.png)

As soon as any of two rectangles is rotated, testing for intersection of the two rectangles becomes a lot more complex. You can not use the CGRectIntersect methods anymore.

For further reading i'll have to refer you to this GameDev.net article about [testing intersection of rotated rectangles](http://www.gamedev.net/reference/programming/features/2dRotatedRectCollision/). It is called the **seperating axis test**. Read on below for more pragmatic alternatives though.

### The more pragmatic alternatives

Before thinking about implementing the separating axis test, i would like to point out two things you should consider before going down that rather complex route:

1) Can you do the collision checks similarly effective if they are simply [distance-based](http://www.learn-cocos2d.com/)? The collision box would then simply be a circle. In many cases this is sufficient.

2) Consider using Box2d or Chipmunk physics and use their collision mechanisms to report collisions back to you. There's an interesting discussion on the cocos2d forums about [u](http://www.cocos2d-iphone.org/forum/topic/2692)[sing a physics engine only for collision detection].
