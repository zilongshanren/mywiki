...
url: http://www.learn-cocos2d.com/knowledge-base/tutorial-professional-cocos2d-xcode-project-template/learn-cocos2d-public-content/manual/1601/14933-what-you-will-learn-in-this-cocos2d-xcode-tutorial/
author: Carl says
...
[Tutorial: cocos2d Xcode Project](http://www.learn-cocos2d.com/knowledge-base/tutorial-professional-cocos2d-xcode-project-template/learn-cocos2d-public-content/manual/1601/): What you will learn in this cocos2d Xcode Tutorial
...
I will walk you through the steps of downloading cocos2d from its github repository (a source control system). We then move on to creating an Xcode project that uses cocos2d as a project reference as opposed to simply including the source files of cocos2d. This makes it easier to keep cocos2d up to date.

We go on to add and explain all the important details of Xcode project setup that you will find helpful when developing cocos2d games. You will learn about various important build settings, creating additional build configurations for Ad Hoc and App Store Distribution and creating iPad and memory debugging Targets.

There's also a section that explains common problems when using Box2d or Chipmunk physics and how to solve them. Finally i'll tell you how you can get the completed Xcode project (just [join my Newsletter](http://ymlp.com/signup.php?id=gebusqsgmgj)) and how to install it.
