---
title: b2ContactListener Class Reference
url: http://www.learn-cocos2d.com/box2d-api-reference/API/classb2_contact_listener/
...
| virtual b2ContactListener::~b2ContactListener | ( | ) | ` [inline, virtual]` |

Called when two fixtures begin to touch.

Called when two fixtures cease to touch.

| virtual void b2ContactListener::PostSolve | ( |
|
...
| virtual void b2ContactListener::PreSolve | ( |
|
