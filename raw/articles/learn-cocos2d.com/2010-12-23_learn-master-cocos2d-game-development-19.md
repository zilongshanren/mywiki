...
url: http://www.learn-cocos2d.com/knowledge-base/cocos2d-iphone-faq/learn-cocos2d-public-content/manual/cocos2d-general/15838-how-to-install-the-cocos2d-xcode-project-templates/
author: Max says
...
[FAQ: cocos2d for iPhone](http://www.learn-cocos2d.com/knowledge-base/cocos2d-iphone-faq/learn-cocos2d-public-content/manual/cocos2d-general/): How to install the cocos2d Xcode Project Templates
...
You'll learn how to add the Xcode Project Templates for cocos2d after you downloaded and extracted the cocos2d archive.

### Open a Terminal window

That's a Terminal window. You can find Terminal, the app, in your Applications folder or type "Terminal" in spotlight.

Once the Terminal window is open, type "cd " with a trailing space. Next will drop the folder cocos2d to the Terminal window.

### Change to cocos2d folder

If you select and then just drag & drop the cocos2d folder onto the Terminal window, the full path to cocos2d will be added after the "cd " command you entered previously. Just press Return now.

### Drag & Drop the install-templates.sh

Type "sudo " with a trailing space in the Terminal window.

Then change to the cocos2d folder in Finder and locate the file "install-templates.sh". Drag & drop this file onto the Terminal window, then press Return.

It will ask you for a password. Enter your login password here and press Return. It's the same password that you need to enter when an application asks to be installed.

If everything goes smoothly you should see a bunch of lines that start with "...copying" and hopefully no errors.

### Verify

Start a "New Project" in Xcode and verify that the cocos2d project Templates exist.
