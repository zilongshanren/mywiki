---
title: Config
url: http://www.learn-cocos2d.com/unofficial-cocos2d-api-reference/html/group___config/
...
If enabled, all subclasses of BitmapFontAtlas will draw a bounding box Useful for debugging purposes only. It is recommened to leave it disabled.
...
Enable it if you want to support v0.8 compatbility. Basically, classes without namespaces will work. It is recommended to disable compatibility once you have migrated your game to v0.9 to avoid class name polution
...
If enabled, then the FPS will be drawn using [CCLabelAtlas](http://www.learn-cocos2d.com/unofficial-cocos2d-api-reference/html/interface_c_c_label_atlas/) (fast rendering). You will need to add the fps_images.png to your project. If disabled, the FPS will be rendered using CCLabel (slow rendering)
...
If enabled, all subclasses of LabeltAtlas will draw a bounding box Useful for debugging purposes only. It is recommened to leave it disabled.

To enable set it to a value different than 0. Disabled by default.

| #define CC_NODE_TRANSFORM_USING_AFFINE_MATRIX 1 |

If enabled, [CCNode](http://www.learn-cocos2d.com/unofficial-cocos2d-api-reference/html/interface_c_c_node/) will transform the nodes using a cached Affine matrix. If disabled, the node will be transformed using glTranslate,glRotate,glScale. Using the affine matrix only requires 2 GL calls. Using the translate/rotate/scale requires 5 GL calls. But computing the Affine matrix is relative expensive. But according to performance tests, Affine matrix performs better. This parameter doesn't affect SpriteSheet nodes.
...
If enabled, all subclasses of [CCSprite](http://www.learn-cocos2d.com/unofficial-cocos2d-api-reference/html/interface_c_c_sprite/) will draw a bounding box Useful for debugging purposes only. It is recommened to leave it disabled.

To enable set it to a value different than 0. Disabled by default.

| #define CC_SPRITEBATCHNODE_DEBUG_DRAW 0 |

If enabled, all subclasses of [CCSprite](http://www.learn-cocos2d.com/unofficial-cocos2d-api-reference/html/interface_c_c_sprite/) that are rendered using an [CCSpriteSheet](http://www.learn-cocos2d.com/) draw a bounding box. Useful for debugging purposes only. It is recommened to leave it disabled.
...
If enabled, it will use RGBA8888 (32-bit textures) on Neon devices for [CCLabelTTF](http://www.learn-cocos2d.com/unofficial-cocos2d-api-reference/html/interface_c_c_label_t_t_f/) objects. If it is disabled, or if it is used on another architecture it will use A8 (8-bit textures). On Neon devices, RGBA8888 textures are 6% faster than A8 textures, but then will consule 4x memory.
