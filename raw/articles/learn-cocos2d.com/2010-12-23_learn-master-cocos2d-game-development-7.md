...
url: http://www.learn-cocos2d.com/knowledge-base/cocos2d-iphone-faq/learn-cocos2d-public-content/manual/cocos2d-general/13433-how-do-i-find-out-if-an-action-has-finishedstopped/13434/resolve-true/
author: Max says
...
[FAQ: cocos2d for iPhone](http://www.learn-cocos2d.com/knowledge-base/cocos2d-iphone-faq/learn-cocos2d-public-content/manual/cocos2d-general/): Why does my CCSequence crash with EXC_BAD_ACCESS?
...
You have a crash that stops your game and the debugger shows that the error is somewhere in CCSequence, possibly [CCSequence initOne: two:]

### The offending CCSequence

This crashes when you run it.

### You may get a "missing sentinel" warning

### What's missing? nil!

The culprit is a missing nil at the end of the action list. Remember: the actions list of a sequence must always end with nil!

If you add nil at the end of the list it won't crash anymore.
