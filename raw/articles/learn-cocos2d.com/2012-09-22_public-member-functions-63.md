...
url: http://www.learn-cocos2d.com/api-ref/2.0/cocos2d-iphone-mac/html/interface_c_c_sprite/
...
[CCSprite](http://www.learn-cocos2d.com/api-ref/2.0/cocos2d-iphone-mac/html/interface_c_c_sprite/) is a 2d image ( [http://en.wikipedia.org/wiki/Sprite_(computer_graphics)](https://en.wikipedia.org/wiki/Sprite_(computer_graphics)) )

[CCSprite](http://www.learn-cocos2d.com/api-ref/2.0/cocos2d-iphone-mac/html/interface_c_c_sprite/) can be created with an image, or with a sub-rectangle of an image.

If the parent or any of its ancestors is a [CCSpriteBatchNode](http://www.learn-cocos2d.com/) then the following features/limitations are valid

If the parent is an standard [CCNode](http://www.learn-cocos2d.com/), then [CCSprite](http://www.learn-cocos2d.com/api-ref/2.0/cocos2d-iphone-mac/html/interface_c_c_sprite/) behaves like any other [CCNode](http://www.learn-cocos2d.com/):

The default anchorPoint in [CCSprite](http://www.learn-cocos2d.com/api-ref/2.0/cocos2d-iphone-mac/html/interface_c_c_sprite/) is (0.5, 0.5).
