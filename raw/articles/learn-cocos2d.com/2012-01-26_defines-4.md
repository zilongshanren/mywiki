---
title: Defines
url: http://www.learn-cocos2d.com/api-ref/1.0/cocos2d-iphone/html/cc_macros_8h/
...
`#import "`[ccConfig.h](http://www.learn-cocos2d.com/api-ref/1.0/cocos2d-iphone/html/cc_config_8h/)"
...
Stops and removes the director from memory. Removes the [EAGLView](http://www.learn-cocos2d.com/api-ref/1.0/cocos2d-iphone/html/interface_e_a_g_l_view/) from its parent
...
IMPORTANT: If you want to use another type of render buffer (eg: RGBA8) or if you want to use a 16-bit or 24-bit depth buffer, you should NOT use this macro. Instead, you should create the [EAGLView](http://www.learn-cocos2d.com/api-ref/1.0/cocos2d-iphone/html/interface_e_a_g_l_view/) manually.
