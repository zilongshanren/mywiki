---
title: Playing (with) Video
url: https://bitsquid.blogspot.com/2012/05/playing-with-video.html
author: Niklas
...
*can*be simpler than making in-game content, since it is easier to outsource. Anybody can make a video, but only the core team can make in-game content and they may not have much time left on their hands.Playing a video while streaming in content can be used to hide loading times. An in-game scene could be used in the same way, but a high-fidelity in-game scene might require too much memory, not leaving enough for the content that is streaming in.
...
Why not XviD? Is it that much outdated?

ReplyDeleteI honestly don't know, but I couldn't look into everything, and I've noticed that these days H.264 is a lot more popular.

DeleteI choose theora/ogg when I worked at Tetraedge Games, because using codecs provided by OS was longer to implement (our targets were smartphones) and when we made the choice we didn't have a simple system to manage different assets for targets. It also add a lot of work of conversion and increase the risk of human mistakes.

ReplyDeleteIt was a really hard choice to do because decoding theora without hardware optimization on devices such a iOS impact the quality of video. We were using a 0.5 ratio for the resolution compared to the screen.

An other advantage was the capacity to do what we want with the decoded frame, the Apple solution didn't allow us to put our interface in front of the video,...

Today we can found some optimization for theora codec.

Yes, I've found that out too. If you want to play HD quality video without hardware support then you need the computational power of the PC.


ReplyDeleteSo VPX for HD video really only works on PC/Mac. For other platforms you have to go back to the platform specific libraries.

Looking for a way to enjoy the excitement of craps without risking any real money? Look no further than craps online gratis! With this free online version of the classic casino game, you can roll the virtual dice to your heart's content without spending a penny. So why not give it a try today and see if you can beat the odds and win big?

ReplyDeleteAs your description explains, navigating the complexities of video playback is indeed an intricate task. This calls for technical considerations, legalities and the choice of a proper video-playback library. Your explanation brings to life how developers struggle to make video playbacks that are both smooth and abide by the law.


ReplyDeleteIn addition, commercial towing presents its own challenges and factors to be considered. When choosing a commercial tow truck for commercial purposes, it should have aspects like reliability, towing capacity and legal requirements. Similar to video playback, the legal landscape needs careful consideration of rules and guidelines to facilitate seamless operations within the confines of the law.

This post on video content is so engaging! Videos truly capture attention and enhance user experience. For anyone looking to elevate their online presence, exploring the Best Digital Marketing Companies in Coimbatore can make a significant difference. They can help leverage video and other strategies to maximize reach and engagement. Great read!
