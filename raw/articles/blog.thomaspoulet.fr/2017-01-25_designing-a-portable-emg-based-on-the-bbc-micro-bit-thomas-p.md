---
title: Designing a portable EMG based on the BBC micro:bit | Thomas Poulet
url: https://blog.thomaspoulet.fr/posts/designing-a-portable-emg-based-on-the-bbc-microbit/
...
$$ \frac{3}{1024} = 2.92\times10^{-3} \simeq 3mV $$Thus, a difference in 1 in our ADC output would mean that our signal changed by about 3mV. In our case, even the best signal that we could get might not even be able to modify the ADC output. We need to amplify our electrode signal.
...
![AD623 Doc](../../assets/18e2235bf7b16e67.jpg)


![AD623 Pin](../../assets/689dab46e50ae92e.jpg)
...
$$ V_{out} = \left ( 1 + \frac{100 k\Omega}{R_G} \right )V_C $$## Negative rail
...
![MAX1044 Doc](../../assets/edd29b4499ab7831.jpg)
...
![Schematic](../../assets/d40e4f017bbf0de0.jpg)
...
![Schematic](../../assets/072ed5b2402ea316.jpg)