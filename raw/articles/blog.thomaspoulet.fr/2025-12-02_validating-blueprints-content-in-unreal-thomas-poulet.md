---
title: Validating Blueprints' Content in Unreal | Thomas Poulet
...
The problem is as follows: imagine you created a Blueprint class in the editor, called `GizmoBase`

. You then inherit from this Blueprint to create specialized Gizmos like `GizmoFoo`

and `GizmoBar`

. In each of these specialized Gizmos, you manually add and configure a component.
...
You see, what you are getting as input when validating a Blueprint asset is … a Blueprint object, of class `Blueprint`

. This means any direct cast to your specific type will fail.

What you need to do is compare against the type of the generated class.

![CanValidateSetup function](../../assets/8b5a7b4ce6d26510.png)
...
As previously mentioned, one reason we couldn’t cast the Blueprint to our specific type was because we were dealing with a Blueprint object. Remember, your custom Blueprint is essentially a recipe to generate an object from a base class. In C++, reading that recipe is straightforward, but in Blueprints, it’s a different story.

What we need to do is read that recipe and list out its components.

![Subobject Data Subsystem](../../assets/7be0c1a03b3532cd.png)


Note that I omitted the code checking the class as this function can only be executed if
...
![Component Cast](../../assets/080aa3df6e68699c.png)


You can also do some filtering based on the component’s name.

![Component Name Filtering](../../assets/805e609a521873ba.png)
...
![Validation logic](../../assets/11614808893e8183.png)
