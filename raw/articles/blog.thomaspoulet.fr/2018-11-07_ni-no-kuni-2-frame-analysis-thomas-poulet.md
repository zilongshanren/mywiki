---
title: 'Ni No Kuni 2: frame analysis | Thomas Poulet'
url: https://blog.thomaspoulet.fr/posts/ni-no-kuni-2-frame-analysis/
...
![Schematic](../../assets/a7a18510cd1d5ea3.jpg)
...
![Shadow Maps](../../assets/65e89ecc1b49e349.jpg)
...
![Depth Map](../../assets/a87e8d52786ded7a.jpg)
...
![Normal Map](../../assets/d37957d22e7bb91f.jpg)
...
![Light Map](../../assets/103aee8c8e385b22.jpg)
...
![](../../assets/baddea2b40ec2afb.png)

![](../../assets/f7fb62e48d22bcf6.png)

After several step of downscaling of existing textures that will be used for this effect, the renderer start the processing. The processing is done a eight time smaller texture, 240x135, than the screen resolution. The red channel of the resulting texture is the output of the light scattering calculation, the green channel is a copy of the depth. Note the lower quantization, this texture being a R11G11B10 whereas the original depth is stored with 32 bits precision.
...
![Light Scattering](../../assets/6ad2f6f7517c87a3.jpg)
...
![Color target 1](../../assets/c5c3971313c73c2a.jpg)
...
![Color target 2](../../assets/b6096b07313aaf8d.jpg)
...
![Color target 3](../../assets/e78384d8cfbbf6d4.jpg)
...
![Pants model](../../assets/a3d8a1a265c2fc69.jpg)


The alpha channel is also used to store the dot product of the vertex to the camera.

![Color target 4](../../assets/da8bb0419c24dde5.jpg)


The fourth and final render target is again a mix and match of different information that will be used later, let’s break it down one by one. The green channel will be used during the line art to artistically control the color, and weight of the contour. The blue channel is used as an identifier, the characters have the value 0.27451. This identifier will be used during the ambient occlusion pass to discard all the pixels belonging to the characters. Finally, the alpha channel is a measure of the relative depth of the characters. It will be used during the contour rendering to soften the line art the further it is away from the camera.
...
![](../../assets/fc5076be2638c104.jpg)

![](../../assets/0921bdf02f879b20.jpg)
...
During the next pass, the line art is multisampled 8 times to obtain a smooth line. Once sampled, the final color is obtain using a look up table that was passed as a texture. I have not seen this texture change in the snapshots I have taken, but it is possible to imagine that it can be changed at runtime to vary the line art effect. To attenuate the very harsh contours in some areas, like where the hair splits, the green channel of the fourth render target, is used as a blending factor.

![Line art](../../assets/1a932da861b80dfe.jpg)
...
The setup used here is really standard and is pretty much as described [there](https://www.geeks3d.com/20110405/fxaa-fast-approximate-anti-aliasing-demo-glsl-opengl-test-radeon-geforce/3/). It uses the same 1/128 for `FXAA_REDUCE_MIN`

and 1/8 for the `FXAA_REDUCE_MUM`

, this one is passed as a variable, we can imagine they tried to fine tune it for their performance requirements.
...
![](../../assets/c5c3971313c73c2a.jpg)

![](../../assets/7571740dd7dcb4e7.jpg)
...
![SMAA line detection](../../assets/efc38d9bcbf7a3cf.jpg)
...
![SMAA pattern](../../assets/cc7dda9d321f2b7f.jpg)


![SMAA weight](../../assets/3d61ef3d0bad09be.jpg)


With the weight map ready the final step of the SMAA algorithm is completed and the filtered image is ready.

![SMAA output](../../assets/54af4603199b5554.jpg)
...
![Velocity map](../../assets/1d233779aad1b100.jpg)
...
![Motion blur](../../assets/2f421ffc9e4832d6.jpg)
...
![Outdoor before](../../assets/47ddd3a56e0f88b2.jpg)
...
![Outdoor after](../../assets/f596f013a8181915.jpg)
...
![dof detail](../../assets/a559878f90d7a719.png)


### Bloom

An important part of the visual identity of the game comes from its heavy use of the bloom effect, which alongside the scattering effect shown earlier gives a real sense of majesty to this scene. To achieve the desired result, Ni no Kuni 2 uses three different downscaled blurred versions of the main render color image.

First off, the brighter area are extracted from the color image.

![](../../assets/7e7dbcd883b0a842.jpg)

![](../../assets/eff9e8e6e0263f03.jpg)
...
However, from what I can see, in this scene, only the original darken image is used, the darkened version of the half resolution is rarely. Next a bidirectional Gaussian blur is applied in two passes.

![Bloom blur](../../assets/1698a10162605bf4.jpg)
...
![Bloom 2](../../assets/0edfa2ff8dff6336.jpg)


![Bloom 3](../../assets/4b0bd2fe55ee2124.jpg)


Finally, the bloom is applied on the original color image.

![](../../assets/cd4b5e21a3b6237c.jpg)

![](../../assets/69d3d3aa3a3744f7.jpg)
