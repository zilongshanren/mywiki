...
url: https://gamedev.rs/blog/survey-01/
...
# Hobbyist or developer? [#](https://gamedev.rs#hobbyist-or-developer)

![Respondents identifying as professional or hobbyist](../../assets/ccb230b38cc55538.png)

*Hobbyist*.
It should also be noted that a significant portion
of the self-identified *Professionals* are more accurately described
...
# Are you using Rust for gamedev? [#](https://gamedev.rs#are-you-using-rust-for-gamedev)

![Respondents using Rust in game development](../../assets/38f0b909dacb0b60.png)


*For the free-form answers that follow, a basic eyeballs&hands sentiment analysis
was used to distill 400 replies into digestible form.
The (#) number next to a heading roughly indicates the number of times
that topic came up. Think of it as the signal strength of a given topic.*

## What about Rust as a language and ecosystem presents the biggest NEGATIVES for you as a game developer right now? [#](https://gamedev.rs#what-about-rust-as-a-language-and-ecosystem-presents-the-biggest-negatives-for-you-as-a-game-developer-right-now)
...
### Ecosystem maturity (114) [#](https://gamedev.rs#ecosystem-maturity-114)
...
### Iteration times (68) [#](https://gamedev.rs#iteration-times-68)
...
### Documentation (43) [#](https://gamedev.rs#documentation-43)
...
### Lack of full-featured engines (35) [#](https://gamedev.rs#lack-of-full-featured-engines-35)
...
### Rust learning curve / onboarding to a niche language (29) [#](https://gamedev.rs#rust-learning-curve-onboarding-to-a-niche-language-29)
...
### IDE/RLS story (28) [#](https://gamedev.rs#ide-rls-story-28)
...
### GUI tooling (23) [#](https://gamedev.rs#gui-tooling-23)
...
### Game consoles (13) [#](https://gamedev.rs#game-consoles-13)
...
### Web/mobile support (14) [#](https://gamedev.rs#web-mobile-support-14)

### Allocators (10) [#](https://gamedev.rs#allocators-10)

### C++ interop (7) [#](https://gamedev.rs#c-interop-7)
...
# What about Rust as a language and ecosystem presents the biggest POSITIVES for you as a game developer right now? [#](https://gamedev.rs#what-about-rust-as-a-language-and-ecosystem-presents-the-biggest-positives-for-you-as-a-game-developer-right-now)

### Safety (100) [#](https://gamedev.rs#safety-100)
...
### Performance (89) [#](https://gamedev.rs#performance-89)
...
### Community (69) [#](https://gamedev.rs#community-69)
...
### WASM (web) support (20) [#](https://gamedev.rs#wasm-web-support-20)

### No garbage collection (8) [#](https://gamedev.rs#no-garbage-collection-8)

### ECS; data-driven; data-oriented (8) [#](https://gamedev.rs#ecs-data-driven-data-oriented-8)

### Cross platform (5) [#](https://gamedev.rs#cross-platform-5)

### C interop (3) [#](https://gamedev.rs#c-interop-3)

## Selected quotes [#](https://gamedev.rs#selected-quotes)

The language has a higher upfront cognitive load than any other mainstream language. Which means that on an established, bigger project (maybe with a team behind) the productivity is amazing compared to C++! It’s much easier to express strong & safe interfaces that make bugs just harder to introduce. It really shines in network code that needs to be 100% safe and resist bad actors! My current game server code has 0 unwraps/panics/expects and so I just

knowit can’t crash… I wish I could have that feeling in C++. C++ on the contrary makes it easy to whip up something which then has a 20% crash rate and tanks perf and takes 2 weeks to hammer into shape, and after those 2 weeks it looks like Rust code anyway. Unfortunately, knowing the management culture in the gamedev industry, Rust has an extremely hard road in front of it due to this. In my experience gamedev is plagued by extreme short term (like, 1 month) reasoning resulting in crunches and awful technical tradeoffs. Rust made many choices that delay that fateful “demo day with the execs” because it forces you to do things right. But very few can express why this is valuable up the chain and be listened to.
...
## What do you think should be the game-dev working group’s priorities for the next 3-6 months? [#](https://gamedev.rs#what-do-you-think-should-be-the-game-dev-working-group-s-priorities-for-the-next-3-6-months)

### Documentation (107) [#](https://gamedev.rs#documentation-107)
...
### Cross-platform support (59) [#](https://gamedev.rs#cross-platform-support-59)
...
### Ecosystem promotion & coordination (51) [#](https://gamedev.rs#ecosystem-promotion-coordination-51)
...
### First-grade game engine/framework (46) [#](https://gamedev.rs#first-grade-game-engine-framework-46)
...
### Graphics libraries (33) [#](https://gamedev.rs#graphics-libraries-33)

- Improve accessibility of graphics programming

### Foundational libraries (27) [#](https://gamedev.rs#foundational-libraries-27)
...
### Faster iteration times (17) [#](https://gamedev.rs#faster-iteration-times-17)
...
### Integration with existing toolchains (14) [#](https://gamedev.rs#integration-with-existing-toolchains-14)

- C/C++
- Xcode, Android studio, Visual studio, Blender
- Unity/Unreal/Godot

### Custom allocation story (10) [#](https://gamedev.rs#custom-allocation-story-10)

### Debugging support and IDE integration (5) [#](https://gamedev.rs#debugging-support-and-ide-integration-5)

### Interoperability between libraries (5) [#](https://gamedev.rs#interoperability-between-libraries-5)

## Can you name some libraries you are thankful for or take special interest in? [#](https://gamedev.rs#can-you-name-some-libraries-you-are-thankful-for-or-take-special-interest-in)
...
![Shoutouts to ecosystem projects](../../assets/c19a323854f41390.png)

*Thanks so much to the survey respondents and all the people out there
working tirelessly make Rust a first-tier language and ecosystem for game development.*