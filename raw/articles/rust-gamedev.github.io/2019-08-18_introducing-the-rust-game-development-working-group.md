...
url: https://gamedev.rs/blog/introducing-the-rust-game-development-working-group/
...
## What have we been up to? [#](https://gamedev.rs#what-have-we-been-up-to)
...
, a library that provides a common interface that windowing libraries (such as`raw-window-handle`

`winit`

) can use to talk to graphics libraries (such as`gfx-hal`

).[Work is currently ongoing](https://github.com/rust-gamedev/wg/issues/26)to integrate this into various libraries, and once this is complete, it should be a big step towards making the ecosystem more decoupled. [Discussions on how a pure Rust SPIR-V generator could be implemented](https://github.com/rust-gamedev/wg/issues/23)are currently ongoing, with the aim of reducing our reliance on`shaderc`
...
## How can I get involved? [#](https://gamedev.rs#how-can-i-get-involved)
...
We also have a `#wg-gamedev`

channel on the [official Rust Discord server](https://discord.gg/j6QJsMd),
and get together for [meetings on Google Hangouts every other Wednesday](https://github.com/rust-gamedev/wg#join-the-fun).
Come and join us!

## What’s next? [#](https://gamedev.rs#what-s-next)
