---
title: Showing the Correctness of Quaternion Rotation
url: https://erkaman.github.io/posts/quaternion_rotation.html
...
by showing that $\eqref{eq:quatrot}$ is equivalent to
[Rodrigues'
rotation formula](https://en.wikipedia.org/wiki/Rodrigues%27_rotation_formula). The rotation of $\eqref{eq:quatrot}$ can be
...
our wanted
rotation(see [wikipedia](https://en.wikipedia.org/wiki/Rodrigues%27_rotation_formula#Derivation)
