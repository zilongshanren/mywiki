---
title: How to Sanity Check your Spherical Harmonics Projection Code
url: https://erkaman.github.io/posts/sh_sanity_check.html
...
See the seminal [paper by Ramamoorthi](http://graphics.stanford.edu/papers/envmap/) for more info on this topic.
...
(Taken from [Patapom's blog](https://patapom.com/blog/SHPortal/).)
\begin{align*}
...
[Patapom's blog](https://patapom.com/blog/SHPortal/). This kind of calculation is often called a
*projection* in some literature. After projecting all the nine
...
\end{align*}
We got this analytic answer by plugging it into [Wolfram Alpha](https://www.wolframalpha.com/input/?i=int+(1%2F2)*sqrt(1%2Fpi)*++sin(theta)+dtheta+dphi,+phi%3D0+to+2pi,+theta%3D0+to+pi).
Calculating the next constant is [also easy](https://www.wolframalpha.com/input/?i=int+(1%2F2)*sqrt(3%2Fpi)*++sin(theta)*sin(phi)+++sin(theta)+dtheta+dphi,+phi%3D0+to+2pi,+theta%3D0+to+pi)
\begin{align*}
