---
title: The Gauss-Seidel and Jacobi Methods for Solving Linear Systems
url: https://erkaman.github.io/posts/jacobi_and_gauss_seidel.html
...
solving [systems
of linear equations](https://en.wikipedia.org/wiki/System_of_linear_equations). Our main objective is to describe how the
...
As long as $A$ is a
symmetric [positive
definite matrix](https://en.wikipedia.org/wiki/Positive-definite_matrix), the method will converge towards a solution. In
...
cliffhanger for the [next
article](https://erkaman.github.io/gauss_seidel_graph_coloring.html) in this series.

Source code that implements both methods discussed in the article
can be found in
a [gist](https://gist.github.com/Erkaman/19b9916c6d00e9c54446bce6075769b5). In
