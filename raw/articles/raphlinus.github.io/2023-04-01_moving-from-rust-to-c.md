...
url: https://raphlinus.github.io/rust/2023/04/01/rust-to-cpp.html
...
One of the more limiting aspects of the Rust ecosystem is the near-monoculture of the Cargo build system and package manager. While other build systems are used to some extent (including [Bazel](https://mmapped.blog/posts/17-scaling-rust-builds-with-bazel.html) when integrating into larger polyglot projects), they are not well supported by tools.
...
First, I consider myself a good enough programmer that I can avoid writing code with safety problems. Sure, I’ve been responsible for some CVEs (including [font parsing code in Android](https://nvd.nist.gov/vuln/detail/CVE-2016-2414)), but I’ve learned from that experience, and am confident I can avoid such mistakes in the future.
...
C++ has even more exciting changes to look forward to, including potentially a new syntax as proposed by Herb Sutter [cppfront](https://github.com/hsutter/cppfront), and even the new C++ compatible Carbon language.

Fortunately, we have excellent leadership in the C++ community. Stroustrup’s [paper on safety](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2023/p2739r0.pdf) is a remarkably wise and perceptive document, showing a deep understanding of the problems C++ faces, and presenting a compelling roadmap into the future.

## Community

I’ll close with some thoughts on community. I try not to spend a lot of time on social media, but I hear that the Rust community can be extremely imperious, constantly demanding that projects be rewritten in Rust, and denigrating all other programming languages. I will be glad to be rid of that, and am sure the C++ community will be much nicer and friendlier. In particular, the C++ subreddit is well known for their [sense of humor](https://www.reddit.com/r/cpp/comments/128xpps/comment/jekwww0).
...
We’re looking for people to help with the C++ rewrite. If you’re interested, please join our [Zulip instance](https://xi.zulipchat.com).
