...
url: https://raphlinus.github.io/curves/2019/05/10/spline-licensing-update.html
...
Today I have pushed changes to [spiro](https://github.com/raphlinus/spiro) and the [spline research](https://github.com/raphlinus/spline-research) repositories, changing the license from GNU General Public License to Apache 2 + MIT. In addition, I am passing all patents into the public domain. I’d like to say a few words about why.
