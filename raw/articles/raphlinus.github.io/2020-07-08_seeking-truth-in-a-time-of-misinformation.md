...
url: https://raphlinus.github.io/covid/2020/07/08/seeking-truth.html
...
Online abuse of trust is one of the topics I’ve studied deeply, including significant work toward an unfinished [PhD](https://levien.com/thesis/thesis.pdf), and over two years working on a spam and abuse team at Google. These days my main work is on 2D graphics, but seeing patterns of misinformation about Covid-19 is bringing back interest and motivation to think about these topics.
...
One of the interesting features of Twitter is that people will curate and share lists of people they feel are worth following. My [covid-19 list](https://twitter.com/i/lists/1239639611694911489) is one such, and a lot of thought went into it: I’ve intentionally included people with a wide range of expertise (including, for example, [Joseph Allen](https://twitter.com/j_g_allen) for his insight into healthy buildings and [Dr. Uché Blackstock](https://twitter.com/uche_blackstock) for expertise on health equity). I’ve also deliberately excluded people from this list who express strong political views or often use an emotional tone. Because of the latter criterion, it’s missing people I personally feel are worth listening to, especially [Gregg Gonsalves](https://twitter.com/gregggonsalves) and [Jeremy Konyndyk](https://twitter.com/JeremyKonyndyk). As always, your mileage may vary. The goal of this particular list is not to be comprehensive, it’s to select a set of voices that have excellent signal to noise ratio; for a much more comprehensive list, see [this one curated by Jeff Jarvis](https://twitter.com/i/lists/1237834151694303234).
...
-
Alarmist narratives as well (“if it bleeds, it leads”). An exceptionally good marker for this is the

[D614G mutation](https://www.cell.com/cell/fulltext/S0092-8674(20)30817-5?sf235753727=1). In the mainstream press, including reporters I would ordinarily trust, it’s a widely believed fact that this mutation represents a deadlier strain of the virus. Even before attention on this specific mutation, the excellent[Nextstrain](https://nextstrain.org/)work was often misinterpreted as varying degrees of transmissibility or infectiousness (as*is*the case for influenza). It is possible that there will be a “there there” on D614G, but there’s no evidence yet for practical consequences. -
...
There’s a major discussion to be had regarding the flaws of peer review, including the role of preprints, the gatekeeping role of publishers, and fraudulent paper mills (see [Elisabeth Bik](https://twitter.com/MicrobiomDigest) for a steady stream of offenders on this front), but that’s beyond this blog.
