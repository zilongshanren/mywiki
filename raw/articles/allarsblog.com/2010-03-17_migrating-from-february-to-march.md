---
title: Migrating From February to March
url: https://allarsblog.com/2010/03/17/migrating-from-february-to-march/
...
`log("We are setting our game type."); if (Left(MapName, 10) ~= "HTFrontEnd") { return class'UDKGame'; } `
