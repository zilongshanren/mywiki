---
title: International movement for code rights
url: http://c0de517e.blogspot.com/2010/09/international-movement-for-code-rights.html
...
Code is data. Data is code. Everyone knows that, and not only in

[homoiconic](http://en.wikipedia.org/wiki/Homoiconicity)languages, it's a general truth. Code, data, languages, frameworks, APIs, they are all the same. So why is it that code and engineers do not have the same rights that data and "creatives" have? Code is an art too!We will fight until all our infrastructures and processes will give equal rights to code and data. In particular we want:

-

**Ease of change**. Why data has little to no dependencies? Why it's easy to change a texture, or to replace a placeholder model with a ten times more refined one, while with code we can't? Why do we accept the existence of things like "[code rot](http://en.wikipedia.org/wiki/Software_rot)" or the "[prototry pattern](http://www.lsd.ic.unicamp.br/%7Eoliva/fun/prog/resign-patterns)"? It's easy to throw data away or change it, it has to be easy to do the same with code.-
...
You know that chinese proverb about the fool who is shown the moon and look at the hand ?

Who cares about the grammar.

This post has a LOT more essence than that.

Moreover, if I remember correctly,

DeadCode is ITALIAN => English is not even his native language.

Can you speak or written italian ?

Give him a break.

Yes, English is not my first language but It is also true that I should Check my posts better, I write them always rushing :)


I'll edit this one but it would have been easier if you told me where the grammar mistakes are :)

Thanks to Anonymous and Mr.Rigiroli that sent me some corrections for my bad English. I've edited the article accordingly.
