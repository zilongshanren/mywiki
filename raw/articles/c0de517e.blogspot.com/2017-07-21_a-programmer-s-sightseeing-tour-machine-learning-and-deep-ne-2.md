...
title: 'A programmer''s sightseeing tour: Machine Learning and Deep Neural Networks
  (slides)'
url: https://c0de517e.blogspot.com/2017/07/a-programmers-sightseeing-tour-machine.html
...
Also, when I do these things I tend to spice things up by trying new tools and styles (often the same for one-man programming projects). This time I made the slides (in one day) using

Also, when I do these things I tend to spice things up by trying new tools and styles (often the same for one-man programming projects). This time I made the slides (in one day) using

[Paper](https://www.fiftythree.com/)on an iPad Pro, was quite fun!
Enjoy!
