...
url: https://www.willusher.io/sdl2%20tutorials/2013/08/15/lesson-0-visual-studio/
...
![](../../assets/fa1d312cc095ec4a.png)


![](../../assets/fa1d312cc095ec4a.png)

Add a new folder to this window and navigate to your SDL include directory. If you put
your SDL development files under `C:\`

your include directories panel will look like this
after you’ve selected the include directory correctly.

![](../../assets/6280c079634cf7b8.png)
...
path your entry should look like this if SDL is under `C:\`

and you chose the 32bit libraries.

![](../../assets/4ff263ad89601f4f.png)
...
SDL binary into our executable’s directory. `SDL2.dll`

can be found in the lib directory
...
The program should run successfully but nothing should appear to happen if you’ve configured everything properly. If an error occurs make sure you’ve followed all the steps properly.
