...
url: https://www.willusher.io/graphics/2019/09/06/faster-shadow-rays-on-rtx/
...
the ray when it’s called. In DXR our any hit shader would just call `AcceptHitAndEndSearch`

, in OptiX `optixTerminateRay`

and in
Vulkan `terminateRayNV`

. We can then call trace with any hit shaders forced to be run,
...
![](https://cdn.willusher.io/img/izqMaBd.webp)

*Sponza, 262K triangles*

![](https://cdn.willusher.io/img/DYdbQgS.webp)

*Unshaded, primary ray + shadow only*
...
| Dataset | OGAH | OGCH | RFO |
|---|---|---|---|
| Sponza (720p) | 371.65 MRay/s (17.06 ms) | 373.75 MRay/s (17.00 ms) | 375.67 MRay/s (16.84 ms) |
| Sponza Unshaded (720p) | 378.26 MRay/s (4.93 ms) | 389.31 MRay/s (4.88 ms) | 398.92 MRay/s (4.82 ms) |
| Sponza (1440p) | 386.35 MRay/s (64.44 ms) | 387.23 MRay/s (64.30 ms) | 389.21 MRay/s (63.97 ms) |
| Sponza Unshaded (1440p) | 1.004 GRay/s (7.24 ms) | 1.004 GRay/s (7.24 ms) | 1.005 GRay/s (7.23 ms) |
...
or terminate ray) to be taken as the final hit and the closest hit shader
