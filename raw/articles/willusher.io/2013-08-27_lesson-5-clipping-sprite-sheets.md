...
url: https://www.willusher.io/sdl2%20tutorials/2013/08/27/lesson-5-clipping-sprite-sheets/
...
but provides the clip parameter with a default `nullptr`

value. This version of renderTexture will take
...
the clip rect as a parameter with `nullptr`

as a default value and in the case that a clip was passed, we’ll use
...
if our event is of the type `SDL_KEYDOWN`

and if it is we can check if the key pressed was one of the keys we’re interested
...
I’ll see you again soon in [Lesson 6: True Type Fonts with SDL_ttf!](https://www.willusher.io/sdl2%20tutorials/2013/12/18/lesson-6-true-type-fonts-with-sdl_ttf/)