---
title: 'Notes on FFTs: for implementers'
...
- Prefer radix-4 (or radix-2
2), less so for lower number of multiplies, and more because having fewer passes and fewer loads/stores is good and memory operation count is not negligible for this. - You don’t have to pick strictly between iterative and recursive approaches, and you can get the best of both worlds by recursing for larger to medium sizes, and handling the small sub-FFTs iteratively.
...
Also, I had no idea that non-uninform block convolution was a thing from your previous post. I always wondered how insanely long reverb effects worked in real time.