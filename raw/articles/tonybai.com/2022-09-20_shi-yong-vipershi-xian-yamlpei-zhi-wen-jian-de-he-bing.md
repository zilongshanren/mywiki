---
title: 使用viper实现yaml配置文件的合并
url: https://tonybai.com/2022/09/20/use-viper-to-do-merge-of-yml-configuration-files/
...
![](../../assets/446cfbb8a3f52386.png)


从上图可以知道，我们的工具是基于模板定制最终的配置与安装脚本的，其中：

- templates/conf下面是服务配置；
- templates/manifests下面是服务的
[k8s yaml脚本](https://tonybai.com/2019/02/25/introduction-to-yaml-creating-a-kubernetes-deployment/); - custom/configure文件存储的是针对templates/conf下面服务配置的定制化配置数据；
