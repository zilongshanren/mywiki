---
title: 十分钟入门Go语言
url: https://tonybai.com/2023/02/23/learn-go-in-10-min/
...
- 从
[Go官网下载](https://go.dev/dl)最新版本的Go语言安装包 – https://go.dev/dl/ - 解压安装包，并将其复制到您想要安装的位置，例如：/usr/local/go；如果是Windows、MacOS平台，也可以下载图形化安装的安装包；
