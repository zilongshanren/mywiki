---
title: 理解Golang包导入
url: https://tonybai.com/2015/03/09/understanding-import-packages/
...
[Golang](http://golang.org)使用包（package）这种语法元素来组织源码，所有语法可见性均定义在package这个级别，与Java 、python等语言相比，这算不上什么创新，但与C传统的include相比，则是显得“先进”了许多。

[Golang](http://tonybai.com/tag/golang)中包的定义和使用看起来十分简单：
...
但在使用其提供的export functions时，却用[nsq](http://github.com/bitly/nsq)做前缀包名：
...
博主你好，你能帮我看看这个问题么？实在搞不明白go的包管理http://www.golangtc.com/t/55a39184b09ecc22f60000a9
