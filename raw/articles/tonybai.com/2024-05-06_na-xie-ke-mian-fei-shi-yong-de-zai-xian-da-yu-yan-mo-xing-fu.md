---
title: 那些可免费使用的在线大语言模型服务
url: https://tonybai.com/2024/05/06/those-free-to-use-online-llm-services/
...
![](../../assets/796a9faa4e23ff3a.png)


[本文永久链接](https://tonybai.com/2024/05/06/those-free-to-use-online-llm-services) – https://tonybai.com/2024/05/06/those-free-to-use-online-llm-services

2022年底以[ChatGPT](https://en.wikipedia.org/wiki/ChatGPT)为代表的大语言模型的出现掀起了人工智能应用的新浪潮。这些庞大的语言模型经过对海量文本数据的训练，能够理解和生成逼近人类水平的自然语言，在对话、问答、文本生成、代码编写等领域展现出了惊人的能力。

最初这种能力“垄断”在OpenAI公司的手里，世界各地的AI爱好者们为了能尽快拿到ChatGPT的使用账号，使出了浑身解数，国内朋友更是如此。

不过随着Google、[Meta](https://ai.meta.com/)、[Anthropic](https://claude.ai/)、[xAI](https://x.ai/)等公司的逐步赶上（当然国内像百度、阿里等巨头的也投入巨量研发和成本）以及开源大模型的持续涌现，时隔一年多以后，目前互联网上的大模型服务已成“百花齐放”之势。无论在推理能力还是模型数量上，都有极大的提升，而使用成本则大幅降低。我们再无需局限于OpenAI这一家公司的大模型了，通过一些免费的在线大模型服务即可享受到多样化、高质量的AI服务。
...
### 1.1 [poe.com](https://poe.com/)

![](../../assets/6d80b39ae08e402e.png)


poe.com是我日常使用的大语言模型服务的**第一选择**。它由美版知乎[Quora平台](https://www.quora.com/)开发运营。平台上的人工智能服务由多个不同公司训练的模型提供支持，并针对不同的任务进行了优化。Poe目前支持的机器人包括：OpenAI的ChatGPT、GPT-4和DALL-E 3，Anthropic的Claude Instant、Claude 2和Claude 3，Stability AI的StableDiffusionXL，Google的PaLM 和Gemini-Pro，Meta的[Llama 3](https://tonybai.com/2024/04/23/playing-with-meta-llama3-8b-on-cpu-using-ollama-and-openwebui/)，Playground的Playground-v2，Mistral的Mistral-Medium，以及大量由社区用户自己创建的机器人。
...
### 1.2 [you.com](https://you.com/)

![](../../assets/ee4d9260706866fd.png)
...
#### 1.3.1 [perplexity labs](https://labs.perplexity.ai/)

![](../../assets/a13109b62c664be0.png)


#### 1.3.2 [huggingface chat](https://huggingface.co/chat/)

抱抱脸(huggingface)是AI界的github，他也提供了一些开源大模型的在线聚合服务：

![](../../assets/9c0b700f7eacdb90.png)


#### 1.3.3 [together.ai](https://api.together.xyz/playground/)

together.ai提供的开源ai大模型非常全面，并且如上图所示，用户可以自己调整大模型参数，比如Temperature、Top-P、Top-K等，非常适合一些开源大模型的深度研究者：

![](../../assets/75ff2fc887facda8.png)


#### 1.3.4 [groq cloud](https://console.groq.com/playground)

![](../../assets/d58475f67e022a0c.png)
...
![](../../assets/50a7196ee830df5a.png)


### 2.2 [Google gemini](https://gemini.google.com/app)

Google是AI领军人物，但OpenAI的异军突起打了他一个“措手不及”，不过Google实力还在，从最先推出的bard，到目前全面升级为gemini后，与OpenAI的能力差距在日益缩小。

![](../../assets/313e1a82244f3ddb.png)


### 2.3 [Claude](https://claude.ai/)
...
[智普清言](https://chatglm.cn)– https://chatglm.cn[通义千问](https://tongyi.aliyun.com/qianwen/)– https://tongyi.aliyun.com/qianwen/[文心一言](https://yiyan.baidu.com/welcome)– https://yiyan.baidu.com/welcome[星火大模型](https://xinghuo.xfyun.cn)– https://xinghuo.xfyun.cn[kimi](https://kimi.moonshot.cn/)– https://kimi.moonshot.cn/
