---
title: 再谈C语言位域
url: https://tonybai.com/2013/05/21/talk-about-bitfield-in-c-again/
...
我在日常工作中使用[C语言](http://en.wikipedia.org/wiki/C_(programming_language))中的[位域](http://tonybai.com/2006/06/19/understand-bit-fields/)(bit field)的场景甚少，原因大致有二：
...
我觉得最好还是写作GCC吧，维基上就是GCC，看大小写混写感觉有点别扭

文章第3部分tcphdr的定义，假设使用方案2，小端定义中8个bit的顺序是不是也应该颠倒过来，如下：方案2:__u16 fin:1, syn:1, rst:1, psh:1, ack:1, urg:1, ece:1, cwr:1; res1:4 doff:4

若是16位顺序 那小端是不是才是二楼说的顺序呀博主 静候回答

请问这个问题所属的邮件列表是哪一个？可以给一个关于此问题链接么？

事已久远，已记不得具体是哪个www.linux-kernel.cn的mail list了。