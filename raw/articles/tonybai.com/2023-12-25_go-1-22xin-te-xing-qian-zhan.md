---
title: Go 1.22新特性前瞻
url: https://tonybai.com/2023/12/25/go-1-22-foresight/
...
![](../../assets/453f525287c4a76f.png)


[本文永久链接](https://tonybai.com/2023/12/25/go-1-22-foresight) – https://tonybai.com/2023/12/25/go-1-22-foresight

美国时间2023年12月20日，[Go官方宣布Go 1.22rc1发布](https://groups.google.com/g/golang-announce/c/FIUY9kd7fc0)，开启了为期2个多月的、常规的公测之旅，Go 1.22预计将于2024.2月份正式发布！

![](../../assets/4c3622165ee30d99.png)


除了[在官网下载Go 1.22rc1版本](https://go.dev/dl/#go1.22rc1)进行新特性体验之外，我们还可以通过[在线的Go Playground](https://go.dev/play/)选择“Go dev branch”来体验(相比下载安装，在线版本体验会有一些局限)：

![](../../assets/83e0f695a4e65f17.png)


注：关于Go的多种安装方法，

[《Go语言第一课》]专栏有系统全面的讲解，欢迎订阅阅读。
...
[Go语言精进之路]》一书中有对通过接口调用方法的原理的详尽说明，欢迎阅读。
...
[新版Tracer的设计文档]– https://go.googlesource.com/proposal/+/ac09a140c3d26f8bb62cbad8969c8b154f93ead6/design/60773-execution-tracer-overhaul.md

### 3.4 其他

- “出尔反尔” –
[syscall包：取消弃用(undeprecate)](https://github.com/golang/go/issues/60797)
...
文本涉及的源码可以在[这里](https://github.com/bigwhite/experiments/tree/master/go1.22-foresight)下载。

## 5. 参考资料

-[Go 1.22 Milestone](https://github.com/golang/go/milestone/298) – https://github.com/golang/go/milestone/298
...
大白老师，如何看待go1.22中对slice的Delete等方法的更新？感觉这样做兼容性差，而且实在想不出改变原始切片中的值为0有什么优点

到目前为止，我还没在生产代码中使用过slices包。我看了一下关于Go 1.22中slices.Delete等函数的更新的原始issue – https://github.com/golang/go/issues/63393 ，从讨论的上下文来看，zero的目的是for GC：

clear(s[len(s):oldlen]) // zero/nil out the obsolete elements, for GC

如果我们的切片只是简单的整型切片，这么做意义的确不大。但是如果slice中存储的是指针，那么zero后，指针指向的heap object就可以被gc释放了，但如果不zero，这部分obsolete elements指向的heap object依旧会存在，直到slice的生命周期结束。