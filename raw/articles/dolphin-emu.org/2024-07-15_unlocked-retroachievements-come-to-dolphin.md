---
title: 'Unlocked: RetroAchievements Come to Dolphin'
url: https://dolphin-emu.org/blog/2024/07/15/unlocked-retroachievements-come-dolphin/
author: JMC
...
![](../../assets/bf1bdec3f255ed02.png)

Ah shi-

**RetroAchievements Dolphin Launch Announcement!**[¶](https://dolphin-emu.org#retroachievements-dolphin-launch-announcement)
...
[The Legend of Zelda: The Wind Waker](https://wiki.dolphin-emu.org/index.php?title=The_Legend_of_Zelda:_The_Wind_Waker)[Final Fantasy Crystal Chronicles](https://wiki.dolphin-emu.org/index.php?title=Final_Fantasy_Crystal_Chronicles)[Super Mario Sunshine](https://wiki.dolphin-emu.org/index.php?title=Super_Mario_Sunshine)[Harvest Moon: A Wonderful Life](https://wiki.dolphin-emu.org/index.php?title=Harvest_Moon:_A_Wonderful_Life)[Super Smash Bros. Melee](https://wiki.dolphin-emu.org/index.php?title=Super_Smash_Bros._Melee)[Baten Kaitos Origins](https://wiki.dolphin-emu.org/index.php?title=Baten_Kaitos_Origins)[Kirby Air Ride](https://wiki.dolphin-emu.org/index.php?title=Kirby_Air_Ride)[Star Fox Assault](https://wiki.dolphin-emu.org/index.php?title=Star_Fox:_Assault)[Metal Gear Solid: The Twin Snakes](https://wiki.dolphin-emu.org/index.php?title=Metal_Gear_Solid:_The_Twin_Snakes)[Mario Golf: Toadstool Tour](https://wiki.dolphin-emu.org/index.php?title=Mario_Golf:_Toadstool_Tour)[Luigi's Mansion](https://wiki.dolphin-emu.org/index.php?title=Luigi%27s_Mansion)[Metroid Prime](https://wiki.dolphin-emu.org/index.php?title=Metroid_Prime_(GC))[Star Wars: Rogue Squadron II: Rogue Leader](https://wiki.dolphin-emu.org/index.php?title=Star_Wars_Rogue_Squadron_II:_Rogue_Leader)

For a full list of games, check out the [RetroAchievements GameCube Library](https://retroachievements.org/system/16/games) with more on their way soon! Want to get hunting right away? RetroAchievements integration is available in Dolphin 2407-68 and newer, which can be found on our [downloads page](https://dolphin-emu.org/download/). This will give us a chance to work out some of the kinks before it reaches most of our users in the next release update.

**Activating RetroAchievements**[¶](https://dolphin-emu.org#activating-retroachievements)

By default, RetroAchievements are disabled in Dolphin. To activate integration, you have to log into your [RetroAchievements.org](https://retroachievements.org/) account in Dolphin's new "Achievements" window that's located under the "Tools" dropdown. If you don't have one, you can create a free account on their website.
...
**Achievement Lifestyle**[¶](https://dolphin-emu.org#achievement-lifestyle)
...
On the other hand, you could also take a more active style of Achievement hunting. At any time, you can visit the gamepage on [retroachievements.org](https://retroachievements.org) or through the Achievements menu in Dolphin on the Progress Tab. There you can see what achievements you have, which ones you're missing, and how to obtain any of the achievements. This can be an excellent way to find new challenges in a game you've played through many times before.

Note that in order to get all of the achievements in some games, you might need to start over with a *fresh* savefile. Some games, like [Luigi's Mansion](https://wiki.dolphin-emu.org/index.php?title=Luigi%27s_Mansion) have multiple save slots so this isn't really a problem. But games like [1080 Avalanche](https://wiki.dolphin-emu.org/index.php?title=1080_avalanche) and [Super Smash Bros. Melee](https://wiki.dolphin-emu.org/index.php?title=Super_Smash_Bros._Melee) require starting from a fresh save for many achievements.
...
**Finding the Right Challenge**[¶](https://dolphin-emu.org#finding-the-right-challenge)
...
The game you play also shapes the kinds of achievements you get. Games like [Harvest Moon: A Wonderful Life](https://wiki.dolphin-emu.org/index.php?title=Harvest_Moon:_A_Wonderful_Life) will challenge your time management and min/maxxing skills. Meanwhile, [F-Zero GX](https://wiki.dolphin-emu.org/index.php?title=F-Zero_GX) will be mostly about going fast.
...
#### Old School Mentality[¶](https://dolphin-emu.org#old-school-mentality)
...
Hardcore mode also enables another RetroAchievements feature: Leaderboards. Leaderboards will automatically record your best times and high scores across various games. What each game measures is up to the developer of the achievement set, but the game will let you know when a leaderboard attempt is active. If you think you're better than all of your friends at [Mario Golf: Toadstool Tour](https://wiki.dolphin-emu.org/index.php?title=Mario_Golf:_Toadstool_Tour), prove it! Are you a time trial demon in [Mario Kart: Double Dash!!](https://wiki.dolphin-emu.org/index.php?title=Mario_Kart:_Double_Dash%E2%80%BC)? Show it.

There are a variety of leaderboards across the plethora of launch titles. No matter what kind of player you are, there's likely a leaderboard or two that'll fit your style. You can take a look at the game pages at [retroachievements.org](https://retroachievements.org) to see the various leaderboards.

### A Cooperative Experience[¶](https://dolphin-emu.org#a-cooperative-experience)

With Discord presence support, RetroAchievements can also give live updates of your current position in a game directly to discord. Use this to race friends, or just to show off where you're at in your game. These live updates are context dependant. For instance, in [The Legend of Zelda: Twilight Princess](https://wiki.dolphin-emu.org/index.php?title=The_Legend_of_Zelda:_Twilight_Princess_(GC)) RetroAchievements tracks things like chests opened, heart pieces, bugs collected, etc, while in [Super Mario Sunshine](https://wiki.dolphin-emu.org/index.php?title=Super_Mario_Sunshine) it keeps track of things like shine count and blue coins.

If you're a more private gamer or hiding from work, as per usual, the Discord Rich Presence features can be disabled.

**Multi-Sets**[¶](https://dolphin-emu.org#multi-sets)
...
**Achievement Unlocked - Marrying Two Massive Projects**[¶](https://dolphin-emu.org#achievement-unlocked-marrying-two-massive-projects)
...
One of the things that helped was the [PCSX2](https://pcsx2.net/) implementation of RetroAchievements, which acted as a base for the developers who worked on the Dolphin version of the implementation. As well, their own achievement creation library had to be ported over to work with Dolphin's memory handling.
...
During this process, a secondary build of Dolphin was being developed that worked with their integrated achievement creation system. That way, while RetroAchievements was implemented into Dolphin builds, teams of achievement creators could get to work on developing the achievement sets you see today. Developing these achievement sets was no easy task - depending on the game, an achievement set could take dozens, if not hundreds of hours of work. GameCube games can dynamically allocate memory, use pointers, swap memory between RAM and ARAM, and in some cases like [Star Wars: The Clone Wars](https://wiki.dolphin-emu.org/index.php?title=Star_Wars:_The_Clone_Wars), change the Block Address Tables whenever it wants. It all makes for a difficult job that takes a lot of testing.

![](../../assets/c1acc0b96c1991fc.jpg)
...
**Wait! What about Wii?**[¶](https://dolphin-emu.org#wait-what-about-wii)
...
**Congratulations - You've Mastered This Article**[¶](https://dolphin-emu.org#congratulations-youve-mastered-this-article)

And that's that! We've gone over all of the major notes for using RetroAchievements in Dolphin. For more information on RetroAchievements, across all consoles, check out [their site](https://retroachievements.org/) and [documentation](https://docs.retroachievements.org/general/) for information on supported emulators and various issues.
